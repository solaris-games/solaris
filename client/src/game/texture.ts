...
const TEXTURE_URLS = {
  ...
  STARLESS_NEBULA_1: new URL('../assets/nebula/neb0-starless.webp', import.meta.url).href,
  STARLESS_NEBULA_2: new URL('../assets/nebula/neb1-starless.webp', import.meta.url).href,
  STAR_NEBULA_1: new URL('../assets/nebula/star-nebula-0.webp', import.meta.url).href,
  STAR_NEBULA_2: new URL('../assets/nebula/star-nebula-1.webp', import.meta.url).href,
  STAR_NEBULA_3: new URL('../assets/nebula/star-nebula-2.webp', import.meta.url).href,
