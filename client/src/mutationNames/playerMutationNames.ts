export default class PlayerMutationNames {
  ...
  public static readonly GamePlayerConcededDefeat: string =
    "gamePlayerConcededDefeat";
  ...
  public static readonly GamePlayerReadyToQuit: string =
    "gamePlayerReadyToQuit";
  public static readonly GamePlayerNotReadyToQuit: string =
    "gamePlayerNotReadyToQuit";
