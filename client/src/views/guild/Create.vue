<template>
  <view-container :is-auth-page="true">
    ...
    <ul>
      ...
      <li>
        Assign roles to <strong>Members</strong>, promote players to
    ...
    <form @submit="handleSubmit">
      ...
      <p>
        <span class="text-warning">Warning</span>: Founding a guild costs
        <strong class="text-danger">3 Galactic Credits</strong>.
...
const handleSubmit = async (e: Event) => {
  ...
  if (
    !(await confirm(
      "Found guild",
      `Are you sure you want to found a guild? It will cost 3 galactic credits.`,
    ))
  ) {
    return;
  }
