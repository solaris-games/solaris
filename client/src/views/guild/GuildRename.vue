<template>
  <view-container>
    ...
    <form @submit="handleSubmit">
      ...
      <p><span class="text-warning">Warning</span>: Renaming a guild costs <strong class="text-danger">1 galactic credit</strong>, earn credits by winning official games.</p>
