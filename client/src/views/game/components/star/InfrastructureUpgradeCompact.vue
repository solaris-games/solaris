  ...
  <div class="row bg-dark pt-2 pb-2" v-if="userPlayer">
    <div class="col pe-0">
      <button
        ...
        :class="{
          ...
          'btn-primary': availableCredits < economy,
        }"
        :disabled="
          isHistoricalMode ||
          isUpgradingEconomy ||
      ...
      <button
        ...
        :class="{
          ...
          'btn-primary': availableCredits < industry,
        }"
        :disabled="
          isHistoricalMode ||
          isUpgradingIndustry ||
      ...
      <button
        ...
        :class="{
          ...
          'btn-primary': availableCredits < science,
        }"
        :disabled="
          isHistoricalMode ||
          isUpgradingScience ||
    ...
    <div class="col-auto ps-0" v-if="userPlayer">
      <button
        ...
        :disabled="
          isHistoricalMode ||
          userPlayer.credits < (star.upgradeCosts?.warpGate || 0) ||
          isGameFinished
        "
        class="btn btn-sm btn-primary me-1"
        title="Build a warp gate - Grants x3 speed between warp gates"
        @click="buildWarpGate"
      >
...
import {
  makeUpgrade,
  makeWarpgateActions,
} from "@/views/game/components/star/upgrade";
import {
