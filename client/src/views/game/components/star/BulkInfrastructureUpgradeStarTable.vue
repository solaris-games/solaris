        ...
        <table class="table table-striped table-hover mb-0">
          <thead class="table-dark">
            <tr>
              ...
              <td v-if="!isSplitResources">
                <a href="javascript:;" @click="sort(['naturalResources'])"
                  >Resources</a
                >
              </td>
              <td
          ...
          <tbody>
            <bulk-infrastructure-upgrade-star-table-row
...
const tableData = computed(() =>
  game.value.galaxy.stars.filter(
    (s) => s.ownedByPlayerId === userPlayer.value._id,
  ),
);
const isSplitResources = computed(() =>
  GameHelper.isSplitResources(game.value),
);
