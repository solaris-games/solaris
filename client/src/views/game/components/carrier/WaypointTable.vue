        ...
        <tr>
          ...
          <th class="col-6" v-if="!isEditMode && showAction" title="Show ETAs">
            <a
              ...
              @click="toggleShowAction"
            >
              [&nbsp;<span class="link-active">ETA</span
              >&nbsp;|&nbsp;Action&nbsp;]
            </a>
          </th>
...
const onEditWaypointRequested = (wp: CarrierWaypoint<string>) =>
  emit("onEditWaypointRequested", wp);
