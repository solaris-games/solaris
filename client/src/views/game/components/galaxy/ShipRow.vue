<template>
  <tr>
    <td>
      <player-icon
        v-if="ship.ownedByPlayerId"
        :playerId="ship.ownedByPlayerId"
      />
    </td>
    <td>
      <a href="javascript:;" @click="clickShip">{{ ship.name }}</a>
    </td>
    <td>
      <a href="javascript:;" @click="goToShip"><i class="far fa-eye"></i></a>
    </td>
    <td>
    ...
    <td>
      <specialist-icon
        :type="ship.type === 'star' ? 'star' : 'carrier'"
