<template>
  <tr>
    ...
    <td>
      <a href="javascript:;" @click="clickStar(star._id)">{{ star.name }}</a>
    </td>
    <td class="no-padding">
      <a href="javascript:;" @click="goToStar(star)"
    ...
    <td>
      <a
        v-if="star.isWormHole && star.wormHolePairStar != null"
        href="javascript:;"
        @click="clickStar(star.wormHoleToStarId!)"
        >{{ star.wormHolePairStar.name }}</a
      >{{ star.isWormHole && star.wormHolePairStar == null ? "???" : null }}
    </td>
    <td class="no-padding">
      <a
        v-if="star.wormHolePairStar != null"
        href="javascript:;"
        @click="goToStar(star.wormHolePairStar)"
        ><i class="far fa-eye"></i
      ></a>
    </td>
    <td title="Wormhole destination owner">
      <player-icon
        v-if="star.wormHolePairStar?.ownedByPlayerId != null"
        :playerId="star.wormHolePairStar.ownedByPlayerId"
      />
    </td>
  </tr>
</template>
