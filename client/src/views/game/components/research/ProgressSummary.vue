        ...
        <table class="table table-sm mb-1" v-if="research">
          <tbody>
            ...
            <tr v-if="isTechnologyEnabled('hyperspace')">
              ...
              <td>
                <span
                  ...
                  v-tooltip:bottom="
                    'Determines how far your carriers can travel in a single jump'
                  "
                  >Hyperspace Range</span
                >
              </td>
              <td>
                <span class="level-label">Level</span>
              ...
              <td
                class="text-end"
                v-if="isTechnologyResearchable('hyperspace')"
              >
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines how far your carriers can travel in a single jump"
                />
              </td>
            </tr>
            <tr v-if="isTechnologyEnabled('terraforming')">
              ...
              <td
                class="text-end"
                v-if="isTechnologyResearchable('terraforming')"
              >
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines infrastructure cost. The higher the terraforming level, the lower infrastructure will cost to upgrade"
                />
              </td>
            </tr>
            <tr v-if="isTechnologyEnabled('experimentation')">
              <td class="row-icon">
                <i :class="getIcon('experimentation')"></i>
              </td>
              ...
              <td
                class="text-end"
                v-if="isTechnologyResearchable('experimentation')"
              >
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines how many research points are awarded at the end of the galactic cycle to a random technology"
                />
              </td>
            </tr>
            <tr v-if="isTechnologyEnabled('weapons')">
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines combat strength of your ships"
                />
              </td>
            </tr>
            <tr v-if="isTechnologyEnabled('banking')">
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines how many credits are awarded at the end of the galactic cycle"
                />
              </td>
            </tr>
            <tr v-if="isTechnologyEnabled('manufacturing')">
              <td class="row-icon">
                <i :class="getIcon('manufacturing')"></i>
              </td>
              <td>Manufacturing</td>
              <td>
                <span class="level-label">Level</span>
              ...
              <td
                class="text-end"
                v-if="isTechnologyResearchable('manufacturing')"
              >
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines how many ships are built via industrial infrastructure per tick"
                />
              </td>
            </tr>
            <tr v-if="isTechnologyEnabled('specialists')">
              ...
              <td
                class="text-end"
                v-if="isTechnologyResearchable('specialists')"
              >
              ...
              <td class="text-end">
                <help-tooltip
                  tooltip="Determines how many specialist tokens are awarded at the end of the galactic cycle"
                />
              </td>
            </tr>
          </tbody>
...
const getRequiredTotal = (key: ResearchTypeNotRandom) =>
  services.researchProgressService.getRequiredResearchProgress(
    game.value,
    key,
    research.value[key].level,
  );
const isTechnologyEnabled = (key: ResearchTypeNotRandom) =>
  services.technologyService.isTechnologyEnabled(game.value, key);
const isTechnologyResearchable = (key: ResearchTypeNotRandom) =>
  services.technologyService.isTechnologyResearchable(game.value, key);
const getIcon = (key: ResearchTypeNotRandom) =>
  `fas fa-${TechnologyHelper.getIcon(key)}`;
</script>
