<template>
  <div>
    ...
    <table
      v-if="!isLoading && completedGames.length"
    ...
    >
      ...
      <tbody>
        <tr v-for="game in completedGames" v-bind:key="game._id">
          <td>
            <span v-if="game.userNotifications.position === 1" class="me-1"
              ><i class="fas fa-medal gold"></i
            ></span>
            <span v-if="game.userNotifications.position === 2" class="me-1"
              ><i class="fas fa-medal silver"></i
            ></span>
            <span v-if="game.userNotifications.position === 3" class="me-1"
              ><i class="fas fa-medal bronze"></i
            ></span>
            <span v-if="GameHelper.isTeamConquest(game)" class="me-1"
          ...
          <td class="d-none d-sm-table-cell text-end" v-if="game.state.endDate">
...
const getEndDateFromNow = (game: ListGame<string>) =>
  DateTime.fromJSDate(game.state.endDate!).toRelative();
