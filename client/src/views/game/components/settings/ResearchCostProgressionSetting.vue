<template>
  <game-setting-value
    :title="name + ' Research Cost Progression'"
    :tooltip="
      'Determines the growth of research points needed for the next level of ' +
      name
    "
  ...
  <game-setting-value
    ...
    :tooltip="'Determines the speed of exponential growth for ' + name"
    :valueText="getFriendlyText(progression.growthFactor)"
    :value="progression.growthFactor"
  />
  <game-setting-value
    v-if="progression.progression === 'cumulative'"
    title="Cumulative scaling factor"
    :tooltip="
      'Determines the scaling factor applied cumulatively per level for ' + name
    "
