<template>
  <div>
    ...
    <div v-if="game && compareSettings">
      <p class="mb-2">
        <small
          >Settings are <span class="text-warning">highlighted</span> if they
          differ from standard.</small
        >
      </p>
        ...
        <table class="table table-striped table-hover">
          <tbody>
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.conquest.victoryCondition)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.conquest.capitalStarElimination)
              "
            ...
            />
            <game-setting-value
              title="Player Online Status"
              tooltip="Determines whether players can see who is online in real time"
              :valueText="
                getFriendlyText(game.settings.general.playerOnlineStatus)
              "
        ...
        <table class="table table-striped table-hover">
          <tbody>
            ...
            <game-setting-value
              ...
              :valueText="
                game.settings.gameTime.speed >= 60
                  ? game.settings.gameTime.speed / 60 + ' minute(s)/tick'
                  : game.settings.gameTime.speed + 'second(s)/tick'
              "
            ...
            <game-setting-value
              ...
              :valueText="
                game.settings.gameTime.afk.turnTimeout + ' missed turns'
              "
        ...
        <table class="table table-striped table-hover">
          <tbody>
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.specialGalaxy.warpgateCost)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.specialGalaxy.darkGalaxy)
              "
            ...
            <game-setting-value
              ...
              :compareValue="
                compareSettings.specialGalaxy.carrierToCarrierCombat
              "
            />
            <game-setting-value
              title="Split Resources"
              ...
              :valueText="
                getFriendlyText(game.settings.specialGalaxy.splitResources)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.specialGalaxy.playerDistribution)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.specialGalaxy.starCaptureReward)
              "
        ...
        <table class="table table-striped table-hover">
          <tbody>
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.orbitalMechanics.enabled)
              "
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            ...
            />
            <game-setting-value
              title="Starting Specialist Tokens"
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.player.developmentCost.economy)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.player.developmentCost.industry)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.player.developmentCost.science)
              "
        ...
        <table class="table table-striped table-hover">
          <tbody>
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.player.populationCap.enabled)
              "
              :value="game.settings.player.populationCap.enabled"
              :compareValue="compareSettings.player.populationCap.enabled"
            />
            <game-setting-value
              title="Ships Per Star"
              v-if="game.settings.player.populationCap.enabled === 'enabled'"
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            ...
            />
            <game-setting-value
              title="Alliance Only Trading"
              tooltip="If enabled, players can only trade with formal allies"
              :valueText="
                getFriendlyText(game.settings.diplomacy.tradeRestricted)
              "
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            <game-setting-value
              title="Starting Terraforming Level"
              ...
              "
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.terraforming
              "
            />
            <game-setting-value
              title="Starting Experimentation Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              "
              :compareValue="
                compareSettings.technology.startingTechnologyLevel
                  .experimentation
              "
            />
            <game-setting-value
              title="Starting Scanning Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.scanning
              "
            />
            <game-setting-value
              title="Starting Hyperspace Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              "
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.hyperspace
              "
            />
            <game-setting-value
              title="Starting Manufacturing Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              "
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.manufacturing
              "
            />
            <game-setting-value
              title="Starting Banking Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.banking
              "
            />
            <game-setting-value
              title="Starting Weapons Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.weapons
              "
            />
            <game-setting-value
              title="Starting Specialists Level"
              tooltip="Determines the starting technology level for all players"
              :valueText="
              ...
              "
              :compareValue="
                compareSettings.technology.startingTechnologyLevel.specialists
              "
              v-if="
                game.settings.specialGalaxy.specialistsCurrency ===
                'creditsSpecialists'
            ...
            <game-setting-value
              ...
              :compareValue="
                compareSettings.technology.researchCosts.terraforming
              "
            />
            <game-setting-value
              title="Experimentation Cost"
              tooltip="Determines how many research points it takes to level up the technology"
              :valueText="
                getFriendlyText(
              ...
              :compareValue="
                compareSettings.technology.researchCosts.experimentation
              "
            />
            <game-setting-value
              title="Scanning Cost"
            ...
            <game-setting-value
              ...
              :compareValue="
                compareSettings.technology.researchCosts.hyperspace
              "
            />
            <game-setting-value
              ...
              :compareValue="
                compareSettings.technology.researchCosts.manufacturing
              "
            />
            <game-setting-value
              title="Banking Cost"
              tooltip="Determines how many research points it takes to level up the technology"
              :valueText="
                getFriendlyText(game.settings.technology.researchCosts.banking)
              "
            ...
            <game-setting-value
              ...
              :compareValue="
                compareSettings.technology.researchCosts.specialists
              "
            />
            <game-setting-value
              title="Banking Reward"
              tooltip="Determines the amount of credits awarded for the banking technology at the end of a galactic cycle"
              :valueText="
                getFriendlyText(game.settings.technology.bankingReward)
              "
            ...
            <game-setting-value
              ...
              :valueText="
                getFriendlyText(game.settings.technology.experimentationReward)
              "
