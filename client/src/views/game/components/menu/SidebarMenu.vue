<template>
  ...
  >
    <div class="sidebar-menu-top">
      ...
      <div v-if="!userPlayer && !gameIsJoinable">
        <sidebar-menu-item
          :menuState="{ state: 'leaderboard' }"
          tooltip="Leaderboard (Q)"
          iconClass="fas fa-users"
        />
      </div>
      <sidebar-menu-item
        :menuState="{ state: 'galaxy', menu: undefined }"
        tooltip="Galaxy (G)"
      ...
      <div v-if="userPlayer">
        ...
        />
        <sidebar-menu-item
          :menuState="{ state: 'research' }"
          tooltip="Research (R)"
          iconClass="fas fa-flask"
        />
        <sidebar-menu-item
          :menuState="{ state: 'bulkInfrastructureUpgrade' }"
          tooltip="Bulk Upgrade (B)"
          iconClass="fas fa-money-bill"
        />
        <sidebar-menu-item
          v-if="isFormalAlliancesEnabled"
          :menuState="{ state: 'diplomacy' }"
          tooltip="Diplomacy (D)"
          iconClass="fas fa-globe-americas"
        />
        <sidebar-menu-item
          v-if="isTradeEnabled"
          :menuState="{ state: 'ledger' }"
          tooltip="Ledger (L)"
          iconClass="fas fa-file-invoice-dollar"
        />
        <sidebar-menu-item
          :menuState="{ state: 'gameNotes' }"
          tooltip="Notes (N)"
      ...
      <div v-if="isLoggedIn">
        <sidebar-menu-item
          :menuState="{ state: 'combatCalculator', advanced: false }"
          tooltip="Calculator (C)"
          iconClass="fas fa-calculator"
        />
        <sidebar-menu-item
          :menuState="{ state: 'ruler' }"
          tooltip="Ruler (V)"
    ...
    <div class="sidebar-menu-bottom" v-if="canDisplayBottomBar">
      ...
      ></router-link>
      <a v-if="isLoggedIn" v-on:click="goToMainMenu()" title="Main Menu"
        ><i class="fas fa-chevron-left"></i
      ></a>
      <router-link v-if="!isLoggedIn" to="/" title="Log In"
        ><i class="fas fa-sign-in-alt"></i
      ></router-link>
      <router-link v-if="!isLoggedIn" to="/account/create" title="Register"
