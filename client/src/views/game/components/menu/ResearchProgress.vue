...
const isTechnologyEnabled = computed(() => services.technologyService.isTechnologyEnabled(game.value, userPlayer.value.researchingNow));
const isTechnologyResearchable = computed(() => services.technologyService.isTechnologyResearchable(game.value, userPlayer.value.researchingNow));
...
const researchProgress = computed(() => {
  ...
  const requiredProgress = services.researchProgressService.getRequiredResearchProgress(game.value, userPlayer.value.researchingNow, tech.level);
