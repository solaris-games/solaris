  ...
  <view-container :is-auth-page="true">
    ...
    <form @submit.prevent="handleSubmit" v-if="settings">
      <view-collapse-panel title="Game Settings" :startsOpened="true">
        <div class="mb-2">
          <label for="name" class="col-form-label"
            >Name
            <help-tooltip
              tooltip="The name of the game, make it short and sweet"
          /></label>
          <input
            type="text"
            :required="true"
        ...
        <div class="mb-2">
          <label for="description" class="col-form-label"
            >Description
            <help-tooltip
              tooltip="Give your game a long description detailing some key settings and entice players to join your custom game"
          /></label>
          <textarea
            rows="4"
            class="form-control"
        ...
        <div class="mb-2">
          <label for="password" class="col-form-label"
            >Password
            <help-tooltip
              tooltip="Password protect your game for you and a select group of players"
          /></label>
          <input
            type="password"
            class="form-control"
        ...
        >
          ...
          >
            <option
              v-for="opt in options.conquest.victoryCondition"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        >
          ...
          >
            <option
              v-for="opt in options.conquest.victoryPercentage"
              v-bind:key="opt"
              v-bind:value="opt"
            >
              {{ opt }}% of
              <span
                v-if="
                  settings.conquest.victoryCondition === 'homeStarPercentage'
                "
                >Capital</span
              >
              Stars
          ...
          <label for="conquestCapitalStarElimination" class="col-form-label"
            >Capital Star Elimination
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.conquest.capitalStarElimination"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
      ...
      <view-collapse-panel title="Player Settings" :startsOpened="true">
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          ...
          <select
            ...
            :disabled="isCreatingGame"
            @change="onPlayerLimitChanged"
          >
            <option
              v-for="opt in options.general.playerLimit"
              v-bind:key="opt"
              v-bind:value="opt"
            >
              {{ opt }} Players
        ...
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.general.playerType"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.general.anonymity"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          <label for="playerOnlineStatus" class="col-form-label"
        ...
        <div class="mb-2">
          <label for="advancedAI" class="col-form-label"
            >Advanced AI
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.general.advancedAI"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          <label for="spectators" class="col-form-label"
            >Allow Spectators
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.general.spectators"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
      ...
      <view-collapse-panel title="Game Time Settings" :startsOpened="true">
        <div class="mb-2">
          <label for="gameType" class="col-form-label"
            >Game Type
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.gameTime.gameType"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.gameTime.gameType === 'realTime'">
          <label for="gameSpeed" class="col-form-label"
            >Game Speed
          ...
          >
            <option
              v-for="opt in options.gameTime.speed"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.gameTime.isTickLimited"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.gameTime.isTickLimited === 'enabled'">
          <label for="tickLimit" class="col-form-label"
            >Time Limit (<span class="text-warning"
              >{{ settings.gameTime.tickLimit }} ticks</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.gameTime.gameType === 'realTime'">
          <label for="startDelay" class="col-form-label"
            >Start Delay
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.gameTime.startDelay"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.gameTime.gameType === 'turnBased'">
          <label for="turnJumps" class="col-form-label"
            >Turn Jumps
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.gameTime.turnJumps"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.gameTime.gameType === 'turnBased'">
          <label for="maxTurnWait" class="col-form-label"
            >Max Turn Wait
            <help-tooltip
        ...
        <div class="mb-2">
          <label for="lastSeenTimeout" class="col-form-label"
            >AFK Last Seen Limit (<span class="text-warning"
              >{{ settings.gameTime.afk.lastSeenTimeout }} day(s)</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.gameTime.gameType === 'realTime'">
          <label for="cycleTimeout" class="col-form-label"
            >AFK Galactic Cycle Limit (<span class="text-warning"
              >{{ settings.gameTime.afk.cycleTimeout }} cycles</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.gameTime.gameType === 'turnBased'">
          <label for="turnTimeout" class="col-form-label"
            >AFK Missed Turn Limit (<span class="text-warning"
              >{{ settings.gameTime.afk.turnTimeout }} missed turn(s)</span
            >)
            <help-tooltip
      ...
      <view-collapse-panel title="Flux" :starts-opened="false">
        ...
        <div class="mb-2">
          <label for="fluxEnabled" class="col-form-label"
            >Enabled
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.general.fluxEnabled"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
      ...
      <view-collapse-panel title="Galaxy Settings" :starts-opened="false">
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.galaxy.galaxyType"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          <label for="productionTicks" class="col-form-label"
            >Production Ticks (<span class="text-warning"
              >{{ settings.galaxy.productionTicks }} ticks</span
            >) <help-tooltip tooltip="How many ticks are in a galactic cycle"
          /></label>
          <div class="col">
            <input
              type="range"
      ...
      >
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.specialGalaxy.carrierCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }} Carriers
        ...
        <div class="mb-2">
          <label for="carrierUpkeepCost" class="col-form-label"
            >Carrier Upkeep Cost
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.specialGalaxy.carrierUpkeepCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          <label for="warpgateCost" class="col-form-label"
            >Warpgate Cost
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.specialGalaxy.warpgateCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }} Gates
        ...
        <div class="mb-2">
          <label for="specialistCost" class="col-form-label"
            >Specialist Cost
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.specialGalaxy.specialistCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
        ...
        >
          <label for="specialistsCurrency" class="col-form-label"
            >Specialist Currency
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.specialGalaxy.specialistsCurrency"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomWarpGates" class="col-form-label"
            >Random Warp Gates (<span class="text-warning"
              >{{ settings.specialGalaxy.randomWarpGates }}%</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomWormHoles" class="col-form-label"
            >Random Worm Holes (<span class="text-warning"
              >{{ settings.specialGalaxy.randomWormHoles }}%</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomNebulas" class="col-form-label"
            >Random Nebulas (<span class="text-warning"
              >{{ settings.specialGalaxy.randomNebulas }}%</span
            >)
            <help-tooltip
              tooltip="The percentage of random nebulas are generated in the galaxy - Nebulas conceal the infrastructure and ship counts at the star from all other players"
          /></label>
          <div class="col">
            <input
              type="range"
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomAsteroidFields" class="col-form-label"
            >Random Asteroid Fields (<span class="text-warning"
              >{{ settings.specialGalaxy.randomAsteroidFields }}%</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomBinaryStars" class="col-form-label"
            >Random Binary Stars (<span class="text-warning"
              >{{ settings.specialGalaxy.randomBinaryStars }}%</span
            >)
            <help-tooltip
              tooltip="The percentage of random binary stars are generated in the galaxy - Binary stars start with additional resources"
          /></label>
          <div class="col">
            <input
              type="range"
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomBlackHoles" class="col-form-label"
            >Random Black Holes (<span class="text-warning"
              >{{ settings.specialGalaxy.randomBlackHoles }}%</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
          <label for="randomPulsars" class="col-form-label"
            >Random Pulsars (<span class="text-warning"
              >{{ settings.specialGalaxy.randomPulsars }}%</span
            >)
            <help-tooltip
        ...
        <div class="mb-2">
          <div class="mb-2">
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.darkGalaxy"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2">
            <label for="giftCarriers" class="col-form-label"
              >Gift Carriers
              <help-tooltip
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.giftCarriers"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2">
            <label for="defenderBonus" class="col-form-label"
              >Defender Bonus
              <help-tooltip
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.defenderBonus"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div
            class="mb-2"
            v-if="settings.orbitalMechanics.enabled === 'disabled'"
          >
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.carrierToCarrierCombat"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.splitResources"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
            <label for="resourceDistribution" class="col-form-label"
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.resourceDistribution"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2" v-if="settings.galaxy.galaxyType !== 'custom'">
            <label for="playerDistribution" class="col-form-label"
              >Player Distribution
              <help-tooltip
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.playerDistribution"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2">
            <label for="carrierSpeed" class="col-form-label"
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.carrierSpeed"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
          ...
          <div class="mb-2">
            <label for="starCaptureReward" class="col-form-label"
              >Star Capture Rewards
              <help-tooltip
            ...
            >
              <option
                v-for="opt in options.specialGalaxy.starCaptureReward"
                v-bind:key="opt.value"
                v-bind:value="opt.value"
              >
                {{ opt.text }}
      ...
      <view-collapse-panel title="Orbital Mechanics" :starts-opened="false">
        ...
        >
          Warning: carrier-to-carrier combat is auto-disabled in orbital games.
        </p>

        <div class="mb-2">
          <label for="orbitalMechanicsEnabled" class="col-form-label"
            >Galaxy Rotation
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.orbitalMechanics.enabled"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        >
          ...
          >
            <option
              v-for="opt in options.orbitalMechanics.orbitSpeed"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
      ...
      <view-collapse-panel title="Player Start Settings" :starts-opened="false">
        ...
        >
          <label for="startingCreditsSpecialists" class="col-form-label"
            >Starting Specialist Tokens (<span class="text-warning"
              >{{ settings.player.startingCreditsSpecialists }} tokens</span
            >)
            <help-tooltip
        ...
        <div
          ...
          "
        >
          <label for="tradeCreditsSpecialists" class="col-form-label"
            >Trade Specialist Tokens
            <help-tooltip
        ...
        <div class="mb-2">
          <label for="tradeCost" class="col-form-label"
            >Technology Trade Cost
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.player.tradeCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              <span v-if="opt.value > 0"
                >{{ opt.text }} Trades ${{ opt.value }}/level</span
              >
        ...
        >
          ...
          >
            <option
              v-for="opt in options.player.tradeScanning"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
      ...
      <view-collapse-panel title="Ship Population Cap" :starts-opened="false">
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.player.populationCap.enabled"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div
          class="mb-2"
          v-if="settings.player.populationCap.enabled === 'enabled'"
        >
          <label for="populationCapShipsPerStar" class="col-form-label"
            >Ships Per Star (<span class="text-warning"
              >{{ settings.player.populationCap.shipsPerStar }} Ships</span
            >)
            <help-tooltip
      ...
      <view-collapse-panel title="Formal Alliances" :starts-opened="false">
        ...
        <div class="mb-2" v-if="settings.general.mode !== 'teamConquest'">
          ...
          >
            <option
              v-for="opt in options.diplomacy.enabled"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.diplomacy.enabled === 'enabled'">
          <label for="allianceUpkeepCost" class="col-form-label"
          ...
          >
            <option
              v-for="opt in options.diplomacy.upkeepCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2" v-if="settings.diplomacy.enabled === 'enabled'">
          ...
          >
            <option
              v-for="opt in options.diplomacy.tradeRestricted"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        >
          ...
          >
            <option
              v-for="opt in options.diplomacy.globalEvents"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
      ...
      >
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          <label for="startingInfrastructureEconomy" class="col-form-label"
            >Starting Economic Infrastructure (<span class="text-warning"
              >{{
                settings.player.startingInfrastructure.economy
              }}
              Economy</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          <label for="startingInfrastructureIndustry" class="col-form-label"
            >Starting Industrial Infrastructure (<span class="text-warning"
              >{{
                settings.player.startingInfrastructure.industry
              }}
              Industry</span
            >)
            <help-tooltip
        ...
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          <label for="startingInfrastructureScience" class="col-form-label"
            >Starting Scientific Infrastructure (<span class="text-warning"
              >{{
                settings.player.startingInfrastructure.science
              }}
              Science</span
            >)
            <help-tooltip
        ...
        <div class="mb-2">
          <label for="economyCost" class="col-form-label"
            >Development Cost
            <help-tooltip
          ...
          >
            <option
              v-for="opt in options.player.developmentCost"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }} Economy
      ...
      <view-collapse-panel title="Technology Settings" :starts-opened="false">
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          <label for="startingTechLevelTerraforming" class="col-form-label"
            ...
            >)
            <help-tooltip
              tooltip="Determines the starting technology levels for all players"
          /></label>
          <div class="col">
            <input
              type="range"
        ...
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          <label for="startingTechLevelExperimentation" class="col-form-label"
            >Starting Experimentation Technology (<span class="text-warning"
              >{{
                settings.technology.startingTechnologyLevel.experimentation > 0
        ...
        <div class="mb-2" v-if="!isAdvancedCustomGalaxy">
          <label for="startingTechLevelBanking" class="col-form-label"
            >Starting Banking Technology (<span class="text-warning"
              >{{
                settings.technology.startingTechnologyLevel.banking > 0
        ...
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.technology.researchCosts"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
        ...
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.technology.bankingReward"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        >
          ...
          >
            <option
              v-for="opt in options.technology.experimentationReward"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
        ...
        <div class="mb-2">
          ...
          >
            <option
              v-for="opt in options.technology.specialistTokenReward"
              v-bind:key="opt.value"
              v-bind:value="opt.value"
            >
              {{ opt.text }}
