<template>
  <view-container :is-auth-page="true">
    ...
    <div
      ...
      class="row bg-secondary border-2 mb-4 p-1 support-banner"
      title="Support the project"
    >
      <p class="support-text">
        Solaris is free, open source and does not have ads. Please consider
        donating or purchasing Galactic Credits to support the continued
      ...
      <p class="support-buttons">
        <a
          ...
          href="https://www.buymeacoffee.com/limitingfactor"
          target="_blank"
          >Donate</a
        >
        <a
