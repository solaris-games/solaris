<template>
  <view-container :is-auth-page="true">
    ...
    <div v-if="!isLoading && game">
      ...
      <p class="description" v-if="game.settings.general.description">
        {{ game.settings.general.description }}
      </p>

      <p v-if="isNewPlayerGame" class="text-warning">
        New Player Games do not affect Rank or Victories.
      </p>
      <p v-if="isCustomFeaturedGame" class="text-warning">
        This is a featured game and will award rank points.
      </p>
      ...
      <div class="row mb-1 bg-dark pt-2 pb-2">
        <div class="col">
          <router-link to="/game/list" tag="button" class="btn btn-primary"
        ...
        <div class="col-auto">
          <router-link
            ...
            >Open Game <i class="fas fa-arrow-right"></i
          ></router-link>
        </div>
      </div>
      ...
      <div
        class="row mb-2"
        v-if="
          game.settings.general.type === 'new_player_rt' ||
          game.settings.general.type === 'new_player_tb' ||
          game.settings.general.type === 'tutorial'
        "
      >
...
const isCustomFeaturedGame = computed(
  () =>
    GameHelper.isCustomGame(game.value) &&
    GameHelper.isFeaturedGame(game.value),
);
