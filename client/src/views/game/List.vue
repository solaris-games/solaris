<template>
  <view-container :is-auth-page="true">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" data-bs-toggle="tab" href="#newGames"
          >New Games</a
        >
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#inProgressGames"
          >In Progress</a
        >
      </li>
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#recentlyCompletedGames"
          >Recent</a
        >
      </li>
    </ul>
    ...
    <div class="tab-content pt-2" v-if="games">
      <div class="tab-pane fade show active" id="newGames">
            ...
            >
              ...
              <div class="card-img-overlay">
                ...
                <p class="card-title card-subtitle">
                  ...
                  ({{ games.featured.state.players }}/{{
                    games.featured.settings.general.playerLimit
                  }})
                </p>
              </div>
        ...
        <p>
          These are official games and award rank points.<help-tooltip
            class="ms-1"
            tooltip="Note: New Player games do not award rank points - 1v1 games do not award galactic credits"
          />
        </p>
        ...
        <div class="row" v-if="!isLoading">
            ...
            >
              ...
              <div class="card-img-overlay">
                ...
                <p class="card-title card-subtitle new-player-card-subtitle">
                  ...
                  ({{ games.newPlayerRT.state.players }}/{{
                    games.newPlayerRT.settings.general.playerLimit
                  }})
                </p>
              </div>
              <div class="card-arrow">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6" v-if="games.special">
            ...
            >
              <picture style="display: contents">
                <source
                  :srcset="specialGameWebpSrc || undefined"
                  type="image/webp"
                />
                <img
                  class="card-img"
              ...
              <div class="card-img-overlay">
                <h5 class="card-title special-card-title">
                  <i
                    ...
                    :class="{
                      'fa-moon':
                        games.special.settings.general.type ===
                          'special_dark' ||
                        games.special.settings.general.type === 'special_fog' ||
                        games.special.settings.general.type ===
                          'special_ultraDark',
                      'fa-drumstick-bite':
                        games.special.settings.general.type ===
                  ...
                  ></i>
                  <span class="ms-2">{{
                    games.special.settings.general.name
                  }}</span>
                </h5>
                <p class="card-title card-subtitle special-card-subtitle">
                  {{ getGameTypeFriendlyText(games.special) }}
                  ({{ games.special.state.players }}/{{
                    games.special.settings.general.playerLimit
                  }}) -
            ...
            >
              ...
              <div class="card-img-overlay">
                <h6 class="card-title standard-card-title">
                  ...
                  <span class="ms-2">{{
                    games.standardRT.settings.general.name
                  }}</span>
                </h6>
                <p class="card-title card-subtitle standard-card-subtitle">
                  {{ getGameTypeFriendlyText(games.standardRT) }}
                  ({{ games.standardRT.state.players }}/{{
                    games.standardRT.settings.general.playerLimit
                  }})
                </p>
              </div>
            ...
            >
              ...
              <div class="card-img-overlay">
                <h6 class="card-title standard-card-title">
                  <i class="fas fa-user-astronaut"></i>
                  <span class="ms-2">{{
                    games.standardTB.settings.general.name
                  }}</span>
                </h6>
                <p class="card-title card-subtitle standard-card-subtitle">
                  {{ getGameTypeFriendlyText(games.standardTB) }}
                  ({{ games.standardTB.state.players }}/{{
                    games.standardTB.settings.general.playerLimit
                  }})
                </p>
              </div>
            ...
            >
              ...
              <div class="card-img-overlay">
                <h6 class="card-title standard-card-title">
                  ...
                  <span class="ms-2">{{
                    games.oneVsOneRT.settings.general.name
                  }}</span>
                </h6>
                <p class="card-title card-subtitle standard-card-subtitle">
                  {{ getGameTypeFriendlyText(games.oneVsOneRT) }}
                  ({{ games.oneVsOneRT.state.players }}/{{
                    games.oneVsOneRT.settings.general.playerLimit
                  }})
                </p>
              </div>
            ...
            >
              ...
              <div class="card-img-overlay">
                <h6 class="card-title standard-card-title">
                  <i class="fas fa-user-friends"></i>
                  <span class="ms-2">{{
                    games.oneVsOneTB.settings.general.name
                  }}</span>
                </h6>
                <p class="card-title card-subtitle standard-card-subtitle">
                  {{ getGameTypeFriendlyText(games.oneVsOneTB) }}
                  ({{ games.oneVsOneTB.state.players }}/{{
                    games.oneVsOneTB.settings.general.playerLimit
                  }})
                </p>
              </div>
            ...
            >
              ...
              <div class="card-img-overlay">
                <h5 class="card-title">
                  ...
                  <span class="ms-2">{{
                    games.standardTeam.settings.general.name
                  }}</span>
                </h5>
                <p class="card-title card-subtitle">
                  {{ getGameTypeFriendlyText(games.standardTeam) }}
                  ({{ games.standardTeam.state.players }}/{{
                    games.standardTeam.settings.general.playerLimit
                  }})
                </p>
              </div>
          ...
          <div
            ...
            v-if="games.sixteenPlayerRelaxed"
          >
            <div
              class="card bg-dark text-white p-1"
              @click="
                routeToPath('/game/detail', {
                  id: games.sixteenPlayerRelaxed._id,
                })
              "
            >
              <picture style="display: contents">
              ...
              <div class="card-img-overlay">
                <h5 class="card-title">
                  ...
                  <span class="ms-2">{{
                    games.sixteenPlayerRelaxed.settings.general.name
                  }}</span>
                </h5>
                <p class="card-title card-subtitle">
                  {{ getGameTypeFriendlyText(games.sixteenPlayerRelaxed) }}
                  ({{ games.sixteenPlayerRelaxed.state.players }}/{{
                    games.sixteenPlayerRelaxed.settings.general.playerLimit
                  }})
                </p>
              </div>
          ...
          >
            ...
            <div class="card-img-overlay">
              <h5 class="card-title">
                <i class="fas fa-globe"></i>
                <span class="ms-2">{{
                  games.thirtyTwoPlayerRT.settings.general.name
                }}</span>
              </h5>
              <p class="card-title card-subtitle">
                {{ getGameTypeFriendlyText(games.thirtyTwoPlayerRT) }}
                ({{ games.thirtyTwoPlayerRT.state.players }}/{{
                  games.thirtyTwoPlayerRT.settings.general.playerLimit
                }})
              </p>
            </div>
        ...
        <div class="text-end" v-if="!isLoading">
          ...
          <router-link
            ...
            ><i class="fas fa-dice"></i> View My Games</router-link
          >
        </div>
        ...
        <p class="mb-2">
          <small class="text-warning" v-if="userGames.length"
            >Total Games: {{ userGames.length }}</small
          >
        </p>

        <p>
          These are custom games. <strong>Featured games</strong> will award
          rank points.
        </p>
        ...
        <table
          v-if="!isLoading && userGames.length"
            ...
            <tr v-for="game in userGames" v-bind:key="game._id">
              <td>
                ...
                <span
                  ...
                  v-if="game.settings.general.featured"
                  >Featured</span
                >
              </td>
      ...
      <div class="tab-pane fade" id="tutorials">
        ...
        <p class="text-warning">
          The tutorials are currently being reworked and may not function as
          expected.
        </p>
        ...
        <table
          v-if="!isLoading && tutorialGames.length"
          class="table table-striped table-hover"
        >
          <thead class="table-dark">
            <tr>
          ...
          <tbody>
            <tr v-for="tutorial in tutorialGames" v-bind:key="tutorial.key">
              ...
              <td class="d-none d-sm-table-cell text-center">
                <i v-if="tutorial.completed" class="fas fa-check"></i>
              </td>
              <td class="">
      ...
      <div class="tab-pane fade" id="inProgressGames">
        ...
        <p class="mb-1">
          These games are in progress, you can join games with open slots.
          <b>Fill slots to earn additional rank points!</b>
          <help-tooltip
            class="ms-1"
            tooltip="This player has filled an AFK slot and will be awarded 1.5x rank points and lose no rank (minimum 0)"
          />
        </p>

        <p class="mb-2">
          <small class="text-warning" v-if="inProgressGames.length"
            >Total Games: {{ inProgressGames.length }}</small
          >
        </p>
        ...
        <p
          v-if="!isLoading && !inProgressGames.length"
          ...
          <tbody>
            <tr v-for="game in inProgressGames" v-bind:key="game._id">
              <td>
                ...
                <span class="badge bg-warning" v-if="game.state.openSlots"
                  >{{ game.state.openSlots }} Open Slot<span
                    v-if="game.state.openSlots > 1"
                    >s</span
                  ></span
                >
                <br />
      ...
      <div class="tab-pane fade" id="recentlyCompletedGames">
        ...
        <p class="mb-1">
          These are games that finished recently, you can view the end result.
        </p>

        <loading-spinner :loading="isLoading" />

        <p
          v-if="!isLoading && !recentlyCompletedGames.length"
          class="text-danger mb-2"
        >
        ...
        >
          ...
          <tbody>
            <tr v-for="game in recentlyCompletedGames" v-bind:key="game._id">
              ...
              <td class="d-none d-md-table-cell text-center">
                {{ getFriendlyDate(game.state.endDate!) }}
              </td>
              <td class="d-none d-sm-table-cell text-center">
                {{ game.state.productionTick }}
              </td>
...
const specialGameSrc = computed(
  () =>
    games.value?.special &&
    new URL(
      `../../assets/screenshots/tiles/${games.value.special.settings.general.type}.jpg`,
      import.meta.url,
    ).href,
);
const specialGameWebpSrc = computed(
  () =>
    games.value?.special &&
    new URL(
      `../../assets/screenshots/tiles/${games.value.special.settings.general.type}.webp`,
      import.meta.url,
    ).href,
);
...
const getFeaturedGame = () => {
  const featuredGames = serverGames.value
    .filter((x) => x.settings.general.featured)
    .concat(userGames.value.filter((x) => x.settings.general.featured));

  if (featuredGames.length) {
    return featuredGames[
      RandomHelper.getRandomNumberBetween(0, featuredGames.length - 1)
    ];
  }
