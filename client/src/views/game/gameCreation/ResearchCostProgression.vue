<template>
  <div class="mb-2">
    <label :for="'researchProgression' + name" class="col-form-label"
      >{{ name }} Research Cost Progression
      <help-tooltip
    ...
    >
      <option
        v-for="opt in options.technology.researchCostProgression"
  ...
  <div
    class="mb-2"
    v-if="
      researchProgression && researchProgression.progression === 'exponential'
    "
  >
    <label :for="'researchProgressionFactor' + name" class="col-form-label"
      >{{ name }} Exponential growth factor
    ...
    >
      <option
        v-for="opt in options.technology.researchCostProgressionGrowthFactor"
        v-bind:key="opt.value"
        v-bind:value="opt.value"
      >
        {{ opt.text }}
  ...
  <div
    class="mb-2"
    v-if="
      researchProgression && researchProgression.progression === 'cumulative'
    "
  >
    <label :for="'researchProgressionScaling' + name" class="col-form-label"
      >{{ name }} Cumulative scaling factor
      <help-tooltip
    ...
    >
      <option
        v-for="opt in options.technology.researchCostProgressionScalingFactor"
        v-bind:key="opt.value"
        v-bind:value="opt.value"
      >
        {{ opt.text }}
