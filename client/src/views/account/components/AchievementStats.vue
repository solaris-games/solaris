...
const levelSrc = computed(
  () =>
    new URL(
      `../../../assets/levels/${user.value.achievements.level}.png`,
      import.meta.url,
    ).href,
);
const levelWebpSrc = computed(
  () =>
    new URL(
      `../../../assets/levels/${user.value.achievements.level}.webp`,
      import.meta.url,
    ).href,
);
...
const loadInfrastructureChart = () => {
  infrastructureChartData.value = {
    labels: ["Economy", "Industry", "Science"],
    datasets: [
      {
        data: [
        ...
        backgroundColor: ["#00bc8c", "#F39C12", "#3498DB"],
      },
    ],
  };
};
...
<template>
  ...
  <div class="row" v-if="user">
      ...
      <table class="table table-striped table-hover">
        <tbody>
          <tr>
            <td>Ship Kills</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.kills.ships }}
            </td>
          </tr>
          <tr>
            <td>Ship Losses</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.losses.ships }}
            </td>
          </tr>
          <tr>
            <td>Carrier Kills</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.kills.carriers }}
            </td>
          </tr>
          <tr>
            <td>Carrier Losses</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.losses.carriers }}
            </td>
          </tr>
          <tr>
            <td>Specialist Kills</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.kills.specialists }}
            </td>
          </tr>
          <tr>
            <td>Specialist Losses</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.losses.specialists }}
            </td>
          </tr>
          <tr>
            <td>Stars Captured</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.stars.captured }}
            </td>
          </tr>
          <tr>
            <td>Stars Lost</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.stars.lost }}
            </td>
          </tr>
          <tr>
            <td>Capital Stars Captured</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.homeStars.captured }}
            </td>
          </tr>
          <tr>
            <td>Capital Stars Lost</td>
            <td class="text-end">
              {{ user.achievements.stats.combat.homeStars.lost }}
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="d-none d-md-block col-4">
      <pie-chart
        v-if="militaryChartData"
        :chart-data="militaryChartData"
        :options="militaryChartOptions"
      />
    </div>
  </div>
  ...
  <div class="row" v-if="user">
      ...
      <table class="table table-striped table-hover">
        <tbody>
          <tr>
            <td>Economy</td>
            <td class="text-end">
              {{ user.achievements.stats.infrastructure.economy }}
            </td>
          </tr>
          <tr>
            <td>Industry</td>
            <td class="text-end">
              {{ user.achievements.stats.infrastructure.industry }}
            </td>
          </tr>
          <tr>
            <td>Science</td>
            <td class="text-end">
              {{ user.achievements.stats.infrastructure.science }}
            </td>
          </tr>
          <tr>
            <td>Warp Gates Built</td>
            <td class="text-end">
              {{ user.achievements.stats.infrastructure.warpGates }}
            </td>
          </tr>
          <tr>
            <td>Warp Gates Destroyed</td>
            <td class="text-end">
              {{ user.achievements.stats.infrastructure.warpGatesDestroyed }}
            </td>
          </tr>
          <tr>
            <td>Specialists Hired</td>
            <td class="text-end">
              {{ user.achievements.stats.infrastructure.specialistsHired }}
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="d-none d-md-block col-4">
      <pie-chart
        v-if="infrastructureChartData"
        :chart-data="infrastructureChartData"
  ...
  <div class="row" v-if="user">
      ...
      <table class="table table-striped table-hover">
        <tbody>
          <tr>
            <td>Scanning</td>
            <td class="text-end">
              {{ user.achievements.stats.research.scanning }}
            </td>
          </tr>
          <tr>
            <td>Hyperspace</td>
            <td class="text-end">
              {{ user.achievements.stats.research.hyperspace }}
            </td>
          </tr>
          <tr>
            <td>Terraforming</td>
            <td class="text-end">
              {{ user.achievements.stats.research.terraforming }}
            </td>
          </tr>
          <tr>
            <td>Weapons</td>
            <td class="text-end">
              {{ user.achievements.stats.research.weapons }}
            </td>
          </tr>
          <tr>
            <td>Banking</td>
            <td class="text-end">
              {{ user.achievements.stats.research.banking }}
            </td>
          </tr>
          <tr>
            <td>Manufacturing</td>
            <td class="text-end">
              {{ user.achievements.stats.research.manufacturing }}
            </td>
          </tr>
          <tr>
            <td>Experimentation</td>
            <td class="text-end">
              {{ user.achievements.stats.research.experimentation }}
            </td>
          </tr>
          <tr>
            <td>Specialists</td>
            <td class="text-end">
              {{ user.achievements.stats.research.specialists }}
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="d-none d-md-block col-4">
      <pie-chart
        v-if="researchChartData"
        :chart-data="researchChartData"
        :options="pieChartOptions"
      />
    </div>
  </div>
      ...
      <table class="table table-striped table-hover">
        <tbody>
          <tr>
            <td>Credits Sent</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.creditsSent }}
            </td>
          </tr>
          <tr>
            <td>Credits Received</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.creditsReceived }}
            </td>
          </tr>
          <tr>
            <td>Specialist Tokens Sent</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.creditsSpecialistsSent }}
            </td>
          </tr>
          <tr>
            <td>Specialist Tokens Received</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.creditsSpecialistsReceived }}
            </td>
          </tr>
          <tr>
            <td>Technology Sent</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.technologySent }}
            </td>
          </tr>
          <tr>
            <td>Technology Received</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.technologyReceived }}
            </td>
          </tr>
          <tr>
            <td>Gifts Sent</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.giftsSent }}
            </td>
          </tr>
          <tr>
            <td>Gifts Received</td>
            <td class="text-end">
              {{ user.achievements.stats.trade.giftsReceived }}
            </td>
          </tr>
          <tr>
            <td>Renown Sent</td>
