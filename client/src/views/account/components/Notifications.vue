...
<template>
  <div>
    ...
    <p>
      Configure your subscriptions for in-game notifications below. Whenever the
      subscribed event triggers you will receive a notification.
    </p>
    ...
    <form @submit.prevent="handleSubmit" v-if="subscriptions" class="pb-2">
      <div>
        ...
        <div class="row pt-1 pb-1">
          <label
            for="notifyActiveGamesOnly"
            class="col-12 col-sm-6 col-form-label"
            >Notify Active Games Only
            <help-tooltip
              tooltip="If enabled, you will receive notifications for games where you are not defeated."
          /></label>
      ...
      <div>
        ...
        <div v-if="subscriptions.inapp" class="row pt-1 pb-1">
          <label
            for="notifyForOtherGames"
            class="col-12 col-sm-6 col-form-label"
            >Receive notifications about other games within the game
            <help-tooltip
              tooltip="If enabled, you will receive message notifications for all games while you are in Solaris, not only for the currently open game"
          /></label>
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
      ...
      <div v-if="subscriptions.discord">
        ...
        <div class="row pt-1 pb-1">
          <label for="gameStarted" class="col-12 col-sm-6 col-form-label"
            >Game - Started</label
          >
          <div class="col-12 col-sm-6">
            <select
        ...
        <div class="row pt-1 pb-1">
          <label for="gameEnded" class="col-12 col-sm-6 col-form-label"
            >Game - Finished</label
          >
          <div class="col-12 col-sm-6">
            <select
        ...
        <div class="row pt-1 pb-1">
          <label for="gameTurnEnded" class="col-12 col-sm-6 col-form-label"
            >Game - Turn Ended</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="playerGalacticCycleComplete"
            class="col-12 col-sm-6 col-form-label"
            >Game - Galactic Cycle Completed</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="playerRenownReceived"
            class="col-12 col-sm-6 col-form-label"
            >Game - Renown Received</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="playerResearchComplete"
            class="col-12 col-sm-6 col-form-label"
            >Game - Research Completed</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="playerTechnologyReceived"
            class="col-12 col-sm-6 col-form-label"
            >Trade - Technology Received</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="playerCreditsReceived"
            class="col-12 col-sm-6 col-form-label"
            >Trade - Credits Received</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="playerCreditsSpecialistsReceived"
            class="col-12 col-sm-6 col-form-label"
            >Trade - Specialist Tokens Received</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
        ...
        <div class="row pt-1 pb-1">
          <label
            for="conversationMessageSent"
            class="col-12 col-sm-6 col-form-label"
            >Diplomacy - Message Received</label
          >
          <div class="col-12 col-sm-6">
            <select
              class="form-control"
