...
export class GameRoomClientSocketHandler {
  ...
  constructor(private readonly socket: Socket,
    ...
    this.socket.io.on(ClientSocketEventNames.Reconnect as unknown as 'reconnect', this._reconnectListener);
  }

  destroy() {
    this.socket.io.off(ClientSocketEventNames.Reconnect as unknown as 'reconnect', this._reconnectListener);
  }
}
