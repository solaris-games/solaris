...
export const listDiplomacy = (axios: Axios) => async (gameId: string): Promise<ResponseResult<DiplomaticStatus<string>[]>> => {
  return doGet(axios)(routes.listDiplomacy, { gameId }, {});
}
