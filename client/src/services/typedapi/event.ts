...
export const listEvents = (axios: Axios) =>
  async (gameId: string, page: number, pageSize: number, category: string): Promise<ResponseResult<ListEventsResponse<string>>> => {
    return doGet(axios)(routes.listEvents, {gameId}, { page, pageSize, category }, {withCredentials: true});
  }
