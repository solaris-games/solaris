...
export const listConversations =
  ...
  async (
    gameId: string,
  ): Promise<ResponseResult<ConversationOverview<string>[]>> => {
...
export const listPrivate =
  ...
  async (
    gameId: string,
    withPlayerId: string,
  ): Promise<ResponseResult<ConversationOverview<string> | null>> => {
    return doGet(axios)(
      routes.listPrivate,
      { gameId, withPlayerId },
      {},
...
export const getUnreadCount =
  (axios: Axios) =>
  async (gameId: string): Promise<ResponseResult<{ unread: number }>> => {
    return doGet(axios)(
...
export const detailConversation =
  ...
  ): Promise<ResponseResult<Conversation<string>>> => {
    return doGet(axios)(
      routes.detail,
...
export const sendMessage =
  ...
  async (
    ...
    conversationId: string,
    message: string,
  ): Promise<ResponseResult<ConversationMessageSentResult<string>>> => {
...
export const pinMessage =
  ...
  async (
    ...
    return doPatch(axios)(
      routes.pinMessage,
      { gameId, conversationId, messageId },
      {},
      {},
      { withCredentials: true },
    );
