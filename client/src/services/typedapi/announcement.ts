...
export const getLatestAnnouncement =
  (axios: Axios) =>
  async (): Promise<ResponseResult<Announcement<string> | null>> => {
...
export const getAnnouncementState =
  (axios: Axios) =>
  async (): Promise<ResponseResult<AnnouncementState<string>>> => {
    return doGet(axios)(
      routes.getAnnouncementState,
      {},
      {},
      {
...
export const markAsRead =
  (axios: Axios) => async (): Promise<ResponseResult<null>> => {
