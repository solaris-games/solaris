...
<tr>
    ...
    <td class="text-right"><span v-if="star.ownedByPlayerId">{{star.infrastructure.economy}}</span></td>
    <td class="text-right"><span v-if="star.ownedByPlayerId">{{star.infrastructure.industry}}</span></td>
    <td class="text-right"><span v-if="star.ownedByPlayerId">{{star.infrastructure.science}}</span></td>
