...
<div class="menu-page container pb-2">
    ...
    <div class="row" v-if="!game.state.endDate">
        <div class="col text-center pt-2">
            <p class="mb-0" v-if="game.settings.general.mode === 'conquest' && game.settings.conquest.victoryCondition === 'starPercentage'">Be the first to capture {{game.state.starsForVictory}} of {{game.state.stars}} stars.</p>
            <p class="mb-0" v-if="game.settings.general.mode === 'conquest' && game.settings.conquest.victoryCondition === 'homeStarPercentage'">Be the first to capture {{game.state.starsForVictory}} capitals of {{game.settings.general.playerLimit}} stars.</p>
