...
<div class="menu-page container">
    ...
    <div v-if="!isLoadingSpecialists && specialists.length">
        <div v-for="specialist in specialists" :key="specialist.id" class="row mb-2 pt-1 pb-1 bg-secondary">
            ...
            <div class="col-auto">
                <button class="btn btn-success mt-2" :disabled="isHiringSpecialist || (carrier.specialist && carrier.specialist.id === specialist.id)" @click="hireSpecialist(specialist)">Hire for ${{specialist.cost}}</button>
            </div>
        </div>
    </div>
</div>
