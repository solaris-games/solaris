    ...
    return {
        getAnnouncementState: async (req, res, next) => {
            ...
            const announcementState =
                await container.announcementService.getAnnouncementState(
                    userId,
                );
        ...
        getLatestAnnouncement: async (req, res, next) => {
            const announcement =
                await container.announcementService.getLatestAnnouncement();
        ...
        getCurrentAnnouncements: async (req, res, next) => {
            const announcements =
                await container.announcementService.getCurrentAnnouncements();
