...
export const mapToConversationCreateConversationRequest = (
    body: any,
): ConversationCreateConversationRequest<DBObjectId> => {
    let errors: string[] = [];
...
export const mapToConversationSendMessageRequest = (
    body: any,
): ConversationSendMessageRequest => {
    let errors: string[] = [];
