...
export const mapToTradeSendToPlayerRequest = (
    body: any,
    userId: any,
): TradeSendToPlayerRequest => {
    let errors: string[] = [];
...
export const mapToTradeSendTechnologyToPlayerRequest = (
    body: any,
): TradeSendTechnologyToPlayerRequest => {
    let errors: string[] = [];
