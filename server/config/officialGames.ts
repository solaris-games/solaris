...
export type OfficialGameCategory = StandardGame | CarouselGame;
...
export const specialGameTypes = specialGameSettings.rotation.map(
    (settings) => settings.general.type,
);
