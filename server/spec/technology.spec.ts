...
function setup(starSpecialist?, carrierSpecialist?) {
    specialistService = {
        getByIdStar: () => {
            return starSpecialist || null;
        },
        getByIdCarrier: () => {
            return carrierSpecialist || null;
        },
    };
...
describe("technology", () => {
    ...
    function getCarriersEffectiveWeaponsLevel(
        game,
        players,
        carriers,
        ...
        // @ts-ignore
        return service.getEffectiveWeaponsDetail(
            game,
            group,
            opponents,
            isCarrierToStarCombat,
    ...
    it("should return false for disabled technology", () => {
        ...
        const researchable = service.isTechnologyResearchable(
            game,
            "experimentation",
        );
    ...
    it("should calculate star effective weapons level - Star - No carriers - No specs - No defender bonus", () => {
        ...
        const weapons = service.getStarOwnWeaponsDetail(
            game,
            players,
            star,
            carriersInOrbit,
    ...
    it("should calculate a single carrier weapons buff - No specialist", () => {
        ...
        const buff =
            service._getCarrierWeaponsBuff(
                carrier,
                isCarrierToStarCombat,
                false,
                isCarrierToStarCombat,
    ...
    it("should calculate carrier effective weapons level - Single player - Single carrier - Carrier to star combat", () => {
        const game = {
            settings: { specialGalaxy: { defenderBonus: "disabled" } },
        };
        ...
        const weapons = getCarriersEffectiveWeaponsLevel(
            game,
            players,
            carriers,
            isCarrierToStarCombat,
