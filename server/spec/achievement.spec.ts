...
describe('achievement', () => {
    const incrementAchievementTest = async (key: string, incrementAmount: number, incrementFunctionCallback: any) => {
        let calls = 0;
    ...
    it('should increment specialists hired achievement', async () => {
        incrementAchievementTest('achievements.infrastructure.specialistsHired', 1, async (service: any) => {
            await service.incrementSpecialistsHired(userId, 1);
        });
    });

    it('should increment warp gates built achievement', async () => {
        incrementAchievementTest('achievements.infrastructure.warpGates', 1, async (service: any) => {
            await service.incrementWarpGatesBuilt(userId, 1);
        });
    });

    it('should increment warp gates destroyed achievement', async () => {
        incrementAchievementTest('achievements.infrastructure.warpGatesDestroyed', 1, async (service: any) => {
            await service.incrementWarpGatesDestroyed(userId, 1);
        });
    });

    it('should increment carriers built achievement', async () => {
        incrementAchievementTest('achievements.infrastructure.carriers', 1, async (service: any) => {
            await service.incrementCarriersBuilt(userId, 1);
        });
    });

    it('should increment infrastructure economy built achievement', async () => {
        incrementAchievementTest('achievements.infrastructure.economy', 1, async (service: any) => {
    ...
    it('should increment infrastructure industry built achievement', async () => {
        incrementAchievementTest('achievements.infrastructure.industry', 1, async (service: any) => {
    ...
    it('should increment trade credits specialists received achievement', async () => {
        incrementAchievementTest('achievements.trade.creditsSpecialistsReceived', 1, async (service: any) => {
