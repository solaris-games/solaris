...
describe("diplomacy", () => {
    ...
    beforeEach(() => {
        service = new DiplomacyService(
            fakeGameRepo,
            fakeEventRepo,
            fakeDiplomacyUpkeepService,
        );
    });
    ...
    const setupPlayerDiplomacyGame = (
        playerAStatusToB: DiplomaticState,
        playerBStatusToA: DiplomaticState,
    ) => {
        const game: any = {
            galaxy: {
                players: [
    ...
    const assertGetDiplomaticStatusToPlayer = (
        playerAStatusToB: DiplomaticState,
        playerBStatusToA: DiplomaticState,
        expectedStatus: DiplomaticState,
    ) => {
        const game = setupPlayerDiplomacyGame(
            playerAStatusToB,
            playerBStatusToA,
        );

        let result = service.getDiplomaticStatusToPlayer(
            game,
            _playerIdA,
            _playerIdB,
        );
    ...
    const assertGetDiplomaticStatusBetweenPlayers = (
        playerAStatusToB: DiplomaticState,
        playerBStatusToA: DiplomaticState,
        expectedStatus: DiplomaticState,
    ) => {
        ...
        let result = service.getDiplomaticStatusBetweenPlayers(game, [
            _playerIdA,
            _playerIdB,
        ]);
    ...
    it("should return neutral if all players are neutral", () => {
        ...
        assertGetDiplomaticStatusBetweenPlayers(
            "neutral",
            "neutral",
            "neutral",
        );
