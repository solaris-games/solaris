...
const schema = new Schema({
    settings: {
        ...
        specialGalaxy: {
			...
			randomWarpGates: { type: Types.String, required: true, enum: ['none', 'rare', 'common'], default: 'none' },
			randomWormHoles: { type: Types.String, required: true, enum: ['none', 'rare', 'common'], default: 'none' },
