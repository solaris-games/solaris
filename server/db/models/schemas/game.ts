...
const schema = new Schema({
    settings: {
        general: {
            ...
            awardRankTo: {
                type: Types.String,
                required: false,
                enum: ["all", "winner", "top_n", "teams", "noRankLoss"],
                default: "all",
            },
            awardRankToTopN: {
                type: Types.Number,
        ...
        specialGalaxy: {
            ...
            carrierUpkeepCost: {
                type: Types.String,
                required: true,
                enum: ["none", "cheap", "standard", "expensive"],
                default: "none",
            },
            warpgateCost: {
                type: Types.String,
            ...
            specialistsCurrency: {
                type: Types.String,
                required: true,
                enum: ["credits", "creditsSpecialists"],
                default: "credits",
            },
            randomWarpGates: {
                type: Types.Number,
            ...
            darkGalaxy: {
                type: Types.String,
                required: true,
                enum: ["disabled", "fog", "standard", "extra", "start"],
                default: "start",
            },
            giftCarriers: {
                type: Types.String,
            ...
            resourceDistribution: {
                type: Types.String,
                required: true,
                enum: ["random", "weightedCenter"],
                default: "random",
            },
            playerDistribution: {
                type: Types.String,
                required: true,
                enum: ["circular", "random", "circularSequential"],
                default: "circular",
            },
            carrierSpeed: {
                type: Types.Number,
        ...
        conquest: {
            victoryCondition: {
                type: Types.String,
                required: true,
                enum: ["starPercentage", "homeStarPercentage"],
                default: "starPercentage",
            },
            victoryPercentage: {
                type: Types.Number,
                required: true,
                enum: [25, 33, 50, 66, 75, 90, 100],
                default: 50,
            },
            capitalStarElimination: {
                type: Types.String,
                required: true,
                enum: ["enabled", "disabled"],
                default: "disabled",
        ...
        player: {
            ...
            tradeCost: {
                type: Types.Number,
                required: true,
                enum: [0, 5, 15, 25, 50, 100],
                default: 15,
            }, // TODO: This could be renamed.
            tradeScanning: {
                type: Types.String,
                required: true,
                enum: ["all", "scanned"],
        ...
        technology: {
            ...
            researchCostProgressions: {
                terraforming: {
                    progression: {
                        type: Types.String,
                        required: false,
                        enum: ["standard", "exponential", "cumulative"],
                        default: "standard",
                    },
                    growthFactor: {
                        type: Types.String,
                        required: false,
                        validate: validateNullableEnum([
                            "soft",
                            "medium",
                            "hard",
                        ]),
            ...
            experimentationDistribution: {
                type: Types.String,
                required: true,
                enum: ["random", "current_research"],
                default: "random",
            },
            experimentationReward: {
                type: Types.String,
                required: true,
        ...
        gameTime: {
            ...
            startDelay: {
                type: Types.Number,
                required: true,
                enum: [0, 1, 5, 10, 30, 60, 120, 240, 360, 480, 600, 720, 1440],
                default: 240,
            }, // Time in minutes
            turnJumps: {
                type: Types.Number,
            ...
            afk: {
                lastSeenTimeout: {
                    ...
                    max: 7,
                    default: 2,
                }, // Time in days, real time and turn based
                cycleTimeout: {
                    type: Types.Number,
                    required: true,
                    min: 3,
                    max: 25,
                    default: 3,
                }, // Real time games' production cycle limit
                turnTimeout: {
                    type: Types.Number,
                    required: true,
                    min: 1,
                    max: 60,
                    default: 3,
                }, // Turn based games' missed turn limit
            },
        },
    },
    galaxy: {
    ...
    constants: {
        ...
        research: {
            ...
            sciencePointMultiplier: {
                type: Types.Number,
                required: true,
                default: 1,
            },
            experimentationMultiplier: {
                type: Types.Number,
                required: true,
                default: 1,
            },
        ...
        star: {
            ...
            captureRewardMultiplier: {
                type: Types.Number,
                required: true,
                default: 10,
            },
            captureRewardLimitMultiplier: {
                type: Types.Number,
                required: true,
                default: 1.5,
            },
            homeStarDefenderBonusMultiplier: {
                type: Types.Number,
                required: true,
                default: 1,
            },
...
schema.index(
    { "state.endDate": 1, "galaxy.players.userId": 1 },
    {
        unique: false,
    },
);
