...
const schema = new Schema({
    ...
    hasSentReviewReminder: {
        type: Types.Boolean,
        required: true,
        default: false,
    },
    isAnonymous: { type: Types.Boolean, default: false },
    warnings: [
        {
    ...
    subscriptions: {
        ...
        settings: {
            notifyActiveGamesOnly: {
                ...
                required: false,
                default: false,
            }, // Send notifications only if the user isn't defeated
        },
        discord: {
            gameStarted: {
                type: Types.Boolean,
