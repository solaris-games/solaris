...
const statsSliceRepository = new Repository<StatsSlice<DBObjectId>>(
    StatsSliceModel,
);
...
export default (
    ...
    const statisticsService = new StatisticsService(
        statsSliceRepository,
        userService,
    );

    const initialGameStateService = new InitialGameStateService(
        initialGameStateRepository,
    );
    ...
    const playerServerSocketEmitter = new PlayerServerSocketEmitter(
        socketServer,
    );
    const diplomacyServerSocketEmitter = new DiplomacyServerSocketEmitter(
        socketServer,
    );
    ...
    const playerCycleRewardsService = new PlayerCycleRewardsService(
        starService,
        technologyService,
    ...
    const diplomacyUpkeepService = new DiplomacyUpkeepService(
    ...
    const carrierTravelService = new CarrierTravelService(
        ...
        distanceService,
        starDistanceService,
        diplomacyService as any,
        starDataService,
    ); // todo: fix any once we consolidate common lib and server types
    ...
    const circularMapService = new CircularMapService(
        randomService,
        starService,
        starDistanceService,
        distanceService,
    ...
    const circularBalancedMapService = new CircularBalancedMapService(
        randomService,
        starService,
        starDistanceService,
        distanceService,
    ...
    const spiralMapService = new SpiralMapService(
        randomService,
        starService,
        starDistanceService,
        distanceService,
    ...
    const doughnutMapService = new DoughnutMapService(
        randomService,
        starService,
        starDistanceService,
        distanceService,
    ...
    const irregularMapService = new IrregularMapService(
        starService,
        starDistanceService,
        distanceService,
        resourceService,
    ...
    const mapService = new MapService(
        ...
        spiralMapService,
        doughnutMapService,
        circularBalancedMapService,
        irregularMapService,
        gameTypeService,
        starDataService,
    );
    const playerReadyService = new PlayerReadyService(
        gameRepository,
        gameTypeService,
    );
    ...
    const playerAfkService = new PlayerAfkService(
        gameRepository,
        playerService,
        starService,
        carrierService,
    ...
    const gameJoinService = new GameJoinService(
        userService,
        starService,
        playerService,
        passwordService,
    ...
    const waypointService = new WaypointService<DBObjectId>(
        starService as any,
        distanceService,
        starDistanceService,
        technologyService,
    ...
    const cullWaypointsService = new CullWaypointsService(
        gameRepository,
        starService,
        playerService,
        waypointService,
    ...
    const saveWaypointsService = new SaveWaypointsService(
        gameRepository,
    ...
    const specialistHireService = new SpecialistHireService(
        gameRepository,
        specialistService,
        userAchievementService,
    ...
    const shipTransferService = new ShipTransferService(
        gameRepository,
        carrierService,
        starService,
    );
    ...
    const basicAIService = new BasicAIService(
        starUpgradeService,
        statisticsService,
    );
    ...
    const starMovementService = new StarMovementService(
        mapService,
        starDistanceService,
        specialistService,
        cullWaypointsService,
    ...
    const scheduleBuyService = new ScheduleBuyService(
        gameRepository,
        starUpgradeService,
    );
    ...
    const eventService = new EventService(
        ...
        eventRepository,
        broadcastService,
        combatMaskingService,
    );
    const combatProcessingService = new CombatProcessingService(
        combatService,
        gameTypeService,
        starCaptureService,
        reputationService,
    ...
    const carrierCombatService = new CarrierCombatService(
        carrierTravelService,
        carrierMovementService,
        diplomacyService,
        distanceService,
    ...
    const customGalaxyService = new CustomGalaxyService(
        nameService,
        specialistService,
        playerService,
        playerColourService,
