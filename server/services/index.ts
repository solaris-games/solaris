...
export default (config: Config,
    ...
    const starService = new StarService(gameRepository, randomService, nameService, distanceService, starDistanceService, technologyService, specialistService, userService, gameTypeService, gameStateService, starDataService);
    ...
    const researchService = new ResearchService(gameRepository, technologyService, randomService, playerStatisticsService, starService, userService, gameTypeService, researchProgressService);
    const starUpgradeService = new StarUpgradeService(gameRepository, starService, carrierService, userAchievementService, researchService, technologyService, playerCreditsService, gameTypeService, shipService, starDataService);
    ...
    const tradeService = new TradeService(gameRepository, eventRepository, userService, playerService, diplomacyService, ledgerService, userAchievementService, reputationService, gameTypeService, randomService, playerCreditsService, playerAfkService, scanningService, distanceService);
    ...
    const specialistHireService = new SpecialistHireService(gameRepository, specialistService, userAchievementService, cullWaypointsService, playerCreditsService, starService, gameTypeService, specialistBanService, technologyService, starDataService);
    ...
    const combatMaskingService = new CombatMaskingService(specialistService);
    const eventService = new EventService(EventModel, eventRepository, broadcastService, combatMaskingService);
    const combatProcessingService = new CombatProcessingService(combatService, gameTypeService, starCaptureService, reputationService, playerService, specialistService, starService, eventService);
    const carrierCombatService = new CarrierCombatService(carrierTravelService, carrierMovementService, diplomacyService, distanceService, playerService, specialistService, starService, combatProcessingService);
    const gameTickService = new GameTickService(distanceService, starService, carrierService, researchService, playerService, playerAfkService, historyService, leaderboardService, userService, gameService, technologyService, specialistService, starUpgradeService, reputationService, aiService, battleRoyaleService, starMovementService, diplomacyService, gameTypeService, gameStateService, playerCycleRewardsService, diplomacyUpkeepService, carrierMovementService, carrierGiftService, starContestedService, playerReadyService, shipService, scheduleBuyService, gameLockService, waypointActionService, cullWaypointsService, carrierTravelService, carrierCombatService, combatProcessingService);
    const emailService = new EmailService(config, gameService, userService, leaderboardService, playerService, playerReadyService, gameTypeService, gameStateService);
