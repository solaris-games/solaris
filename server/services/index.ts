...
import { GameServerSocketEmitter } from "../socketEmitters/game";
import { PlayerServerSocketEmitter } from "../socketEmitters/player";
import { DiplomacyServerSocketEmitter } from "../socketEmitters/diplomacy";
import { ServerHandler } from "../socketHandlers/serverHandler";
import { PlayerServerSocketHandler } from "../socketHandlers/player";
...
export default (config: Config,
    ...
    const customMapService = new CustomMapService(carrierService);
