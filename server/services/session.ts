...
export default class SessionService {
     ...
     * */
    public updateUserSessions(userId: DBObjectId, action: (session: SessionData) => void) {
        this.sessionStorage!.all((err: any, obj?: SessionData[] | { [sid: string]: SessionData; } | null) => {
            if (err != null) {
                throw err;
            }
            else {
