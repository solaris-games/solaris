import {
    BaseGameEvent,
    EVENT_TYPES,
    GameDiplomacyPeaceDeclaredEvent,
    GameDiplomacyWarDeclaredEvent,
    GameEndedEvent,
    GameEvent,
    GamePlayerAfkEvent,
    ...
    PlayerDiplomacyStatusChangedEvent,
    PlayerEvent,
    ...
    PlayerStarDiedEvent,
    PlayerStarReignitedEvent,
    PlayerStarSpecialistHiredEvent,
...
export class EventService implements IEventService {
    ...
    async createGameEvent<Ev extends GameEvent<DBObjectId>>(
        gameId: DBObjectId,
        gameTick: number,
        type: Ev["type"],
        data: Ev["data"],
    ...
    async createPlayerEvent<Ev extends PlayerEvent<DBObjectId>>(
        gameId: DBObjectId,
        gameTick: number,
        playerId: DBObjectId,
        type: Ev["type"],
    ...
    async getPlayerEvents(
    ...
    ): Promise<{ count: number; events: BaseGameEvent<DBObjectId>[] }> {
        const query = {
            gameId: gameId,
            playerId: {
                $in: [player._id, null],
        ...
        if (category != null && category !== "all") {
            const categories = {
                ...
                galacticCycles: ["playerGalacticCycleComplete"],
                research: ["playerResearchComplete"],
                specialists: [
    ...
    async createPlayerJoinedEvent(args: InternalGamePlayerJoinedEvent) {
        ...
        return await this.createGameEvent<GamePlayerJoinedEvent<DBObjectId>>(
            args.gameId,
            args.gameTick,
            "gamePlayerJoined",
            data,
    ...
    async createPlayerQuitEvent(args: InternalGamePlayerQuitEvent) {
        ...
        return await this.createGameEvent<GamePlayerQuitEvent<DBObjectId>>(
            args.gameId,
            args.gameTick,
            "gamePlayerQuit",
            data,
    ...
    async createPlayerDefeatedEvent(args: InternalGamePlayerDefeatedEvent) {
        ...
        return await this.createGameEvent<GamePlayerDefeatedEvent<DBObjectId>>(
            args.gameId,
            args.gameTick,
            "gamePlayerDefeated",
            data,
    ...
    async createPlayerAfkEvent(args: InternalGamePlayerAFKEvent) {
        ...
        return await this.createGameEvent<GamePlayerAfkEvent<DBObjectId>>(
            args.gameId,
            args.gameTick,
            "gamePlayerAFK",
            data,
    ...
    async createGameStartedEvent(args: InternalGameEvent) {
        return await this.createGameEvent<GameStartedEvent<DBObjectId>>(
            args.gameId,
            args.gameTick,
            "gameStarted",
            {},
    ...
    async createGameEndedEvent(args: InternalGameEndedEvent) {
        ...
        return await this.createGameEvent<GameEndedEvent<DBObjectId>>(
            args.gameId,
            args.gameTick,
            "gameEnded",
            data,
    ...
    async createPlayerGalacticCycleCompleteEvent(
        data: InternalPlayerGalacticCycleCompletedEvent,
    ) {
        return await this.createPlayerEvent<
            PlayerGalacticCycleCompleteEvent<DBObjectId>
        >(
            data.gameId,
            data.gameTick,
            data.playerId,
    ...
    async createPlayerCombatStarEvent(
        gameId: DBObjectId,
        gameTick: number,
        ...
        for (const group of combatResult.groups) {
            for (const playerId of group.playerIds) {
                const playerCombatResult =
                    this.combatMaskingService.maskCombatResult(
                        combatResult,
                        playerId,
                    );

                await this.createPlayerEvent<PlayerCombatStarEvent<DBObjectId>>(
                    gameId,
                    gameTick,
                    playerId,
                    "playerCombatStar",
    ...
    async createPlayerCombatCarrierEvent(
        gameId: DBObjectId,
        gameTick: number,
        combatResult: CombatResult<DBObjectId>,
    ) {
    ...
    async createResearchCompleteEvent(
        gameId: DBObjectId,
        gameTick: number,
        playerId: DBObjectId,
        ...
        return await this.createPlayerEvent<
            PlayerResearchCompleteEvent<DBObjectId>
        >(gameId, gameTick, playerId, "playerResearchComplete", data);
    }

    async createTechnologyReceivedEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<
            PlayerTechnologyReceivedEvent<DBObjectId>
        >(gameId, gameTick, toPlayer._id, "playerTechnologyReceived", data);
    }

    async createTechnologySentEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<
            PlayerTechnologySentEvent<DBObjectId>
        >(gameId, gameTick, fromPlayer._id, "playerTechnologySent", data, true);
    }

    async createCreditsReceivedEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<
            PlayerCreditsReceivedEvent<DBObjectId>
        >(gameId, gameTick, toPlayer._id, "playerCreditsReceived", data);
    }

    async createCreditsSentEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<PlayerCreditsSentEvent<DBObjectId>>(
            gameId,
            gameTick,
            fromPlayer._id,
            "playerCreditsSent",
    ...
    async createCreditsSpecialistsReceivedEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<
            PlayerSpecialistTokensReceivedEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            toPlayer._id,
    ...
    async createCreditsSpecialistsSentEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<
            PlayerSpecialistTokensSentEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            fromPlayer._id,
    ...
    async createRenownReceivedEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<
            PlayerRenownReceivedEvent<DBObjectId>
        >(gameId, gameTick, toPlayer._id, "playerRenownReceived", data);
    }

    async createRenownSentEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<PlayerRenownSentEvent<DBObjectId>>(
            gameId,
            gameTick,
            fromPlayer._id,
            "playerRenownSent",
    ...
    async createGiftReceivedEvent(
        ...
        return await this.createPlayerEvent<
            PlayerGiftReceivedEvent<DBObjectId>
        >(gameId, gameTick, toPlayer._id, "playerGiftReceived", data);
    }

    async createGiftSentEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
        ...
        return await this.createPlayerEvent<PlayerGiftSentEvent<DBObjectId>>(
            gameId,
            gameTick,
            fromPlayer._id,
            "playerGiftSent",
    ...
    async createStarAbandonedEvent(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        star: Star,
        ...
        return await this.createPlayerEvent<
            PlayerStarAbandonedEvent<DBObjectId>
        >(gameId, gameTick, player._id, "playerStarAbandoned", data, true);
    }

    async createStarDiedEvent(
        gameId: DBObjectId,
        gameTick: number,
        playerId: DBObjectId,
        starId: DBObjectId,
        ...
        await this.createPlayerEvent<PlayerStarDiedEvent<DBObjectId>>(
            gameId,
            gameTick,
            playerId,
            "playerStarDied",
    ...
    async createStarReignitedEvent(
        gameId: DBObjectId,
        gameTick: number,
        playerId: DBObjectId,
        starId: DBObjectId,
        ...
        await this.createPlayerEvent<PlayerStarReignitedEvent<DBObjectId>>(
            gameId,
            gameTick,
            playerId,
            "playerStarReignited",
    ...
    async createInfrastructureBulkUpgraded(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        upgradeReport: BulkUpgradeReport,
    ) {
        const data = {
            upgradeReport,
        };
        ...
        return await this.createPlayerEvent<
            PlayerBulkInfrastructureUpgradedEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            player._id,
    ...
    async createDebtAddedEvent(
        gameId: DBObjectId,
        gameTick: number,
        debtorPlayerId: DBObjectId,
        creditorPlayerId: DBObjectId,
        amount: number,
        ...
        this.broadcastService.gamePlayerDebtAdded(
            debtorPlayerId,
            creditorPlayerId,
            amount,
            ledgerType,
    ...
    async createDebtSettledEvent(
        ...
        await this.createPlayerEvent<PlayerDebtSettledEvent<DBObjectId>>(
            gameId,
            gameTick,
            debtorPlayerId,
            "playerDebtSettled",
        ...
        this.broadcastService.gamePlayerDebtSettled(
            debtorPlayerId,
            creditorPlayerId,
            amount,
            ledgerType,
    ...
    async createDebtForgivenEvent(
        ...
        await this.createPlayerEvent<PlayerDebtForgivenEvent<DBObjectId>>(
            gameId,
            gameTick,
            debtorPlayerId,
            "playerDebtForgiven",
        ...
        this.broadcastService.gamePlayerDebtForgiven(
            debtorPlayerId,
            creditorPlayerId,
            amount,
            ledgerType,
    ...
    async createPlayerStarSpecialistHired(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        star: Star,
        ...
        await this.createPlayerEvent<
            PlayerStarSpecialistHiredEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            player._id,
    ...
    async createPlayerCarrierSpecialistHired(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        carrier: Carrier,
        ...
        await this.createPlayerEvent<
            PlayerCarrierSpecialistHiredEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            player._id,
    ...
    async createPlayerConversationCreated(
        gameId: DBObjectId,
        gameTick: number,
        ...
        await this.createPlayerEvent<
            PlayerConversationCreatedEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            convo.createdBy!,
    ...
    async createPlayerConversationInvited(
        gameId: DBObjectId,
        gameTick: number,
        convo: Conversation<DBObjectId>,
        playerId: DBObjectId,
        ...
        await this.createPlayerEvent<
            PlayerConversationInvitedEvent<DBObjectId>
        >(gameId, gameTick, playerId, "playerConversationInvited", data);
    }

    async createPlayerConversationLeft(
        gameId: DBObjectId,
        gameTick: number,
        convo: Conversation<DBObjectId>,
        playerId: DBObjectId,
        ...
        await this.createPlayerEvent<PlayerConversationLeftEvent<DBObjectId>>(
            gameId,
            gameTick,
            playerId,
            "playerConversationLeft",
    ...
    async createGamePlayerBadgePurchased(
        args: InternalGamePlayerBadgePurchasedEvent,
    ) {
        const data = {
        ...
        return await this.createGameEvent<
            GamePlayerBadgePurchasedEvent<DBObjectId>
        >(args.gameId, args.gameTick, "gamePlayerBadgePurchased", data);
    }

    async _deleteGameDiplomacyDeclarationsInTick(
        gameId: DBObjectId,
        gameTick: number,
    ...
    async createGameDiplomacyPeaceDeclared(
        args: InternalGameDiplomacyPeaceDeclaredEvent,
    ) {
        const data = args.status;

        return await this.createGameEvent<
            GameDiplomacyPeaceDeclaredEvent<DBObjectId>
        >(args.gameId, args.gameTick, "gameDiplomacyPeaceDeclared", data);
    }

    async createGameDiplomacyWarDeclared(
        args: InternalGameDiplomacyWarDeclaredEvent,
    ) {
        const data = args.status;

        return await this.createGameEvent<
            GameDiplomacyWarDeclaredEvent<DBObjectId>
        >(args.gameId, args.gameTick, "gameDiplomacyWarDeclared", data);
    }

    async createPlayerDiplomacyStatusChanged(
        gameId: DBObjectId,
        gameTick: number,
        status: DiplomaticStatus<DBObjectId>,
    ) {
        ...
        await this.createPlayerEvent<
            PlayerDiplomacyStatusChangedEvent<DBObjectId>
        >(
            gameId,
            gameTick,
            status.playerIdFrom,
