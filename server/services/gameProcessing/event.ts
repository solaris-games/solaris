...
type ProcessingEvent =
    ...
    | {
          kind: "creditsSpecialistsReceived";
          gameId: DBObjectId;
          gameTick: number;
          fromPlayer: Player;
          toPlayer: Player;
    ...
    | ({
          kind: "gameDiplomacyPeaceDeclared";
      } & InternalGameDiplomacyPeaceDeclaredEvent)
    | ({
          kind: "gameDiplomacyWarDeclared";
      } & InternalGameDiplomacyWarDeclaredEvent)
    | ({ kind: "gameEnded" } & InternalGameEndedEvent)
    | ({
          kind: "gamePlayerBadgePurchased";
      } & InternalGamePlayerBadgePurchasedEvent)
    ...
    | {
          kind: "infrastructureBulkUpgraded";
          gameId: DBObjectId;
          gameTick: number;
          player: Player;
    ...
    | {
          kind: "playerCarrierSpecialistHired";
          gameId: DBObjectId;
          gameTick: number;
          player: Player;
          carrier: Carrier;
    ...
    | {
          kind: "playerCombatCarrier";
          gameId: DBObjectId;
          gameTick: number;
          combatResult: CombatResult<DBObjectId>;
      }
    | {
          kind: "playerCombatStar";
          gameId: DBObjectId;
          gameTick: number;
          combatResult: CombatResult<DBObjectId>;
      }
    | {
          kind: "playerConversationCreated";
          gameId: DBObjectId;
          gameTick: number;
          convo: Conversation<DBObjectId>;
      }
    | {
          kind: "playerConversationInvited";
          gameId: DBObjectId;
          gameTick: number;
          convo: Conversation<DBObjectId>;
          playerId: DBObjectId;
    ...
    | {
          kind: "playerDiplomacyStatusChanged";
          gameId: DBObjectId;
          gameTick: number;
          status: DiplomaticStatus<DBObjectId>;
      }
    | ({
          kind: "playerGalacticCycleComplete";
      } & InternalPlayerGalacticCycleCompleteEvent)
    | ({ kind: "playerJoined" } & InternalGamePlayerJoinedEvent)
    | ({ kind: "playerQuit" } & InternalGamePlayerQuitEvent)
    | {
          kind: "playerStarSpecialistHired";
          gameId: DBObjectId;
          gameTick: number;
          player: Player;
          star: Star;
...
export class ProcessingEventService implements IEventService {
    ...
    createCreditsSpecialistsReceivedEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
    ...
    createCreditsSpecialistsSentEvent(
        gameId: DBObjectId,
        gameTick: number,
        fromPlayer: Player,
        toPlayer: Player,
    ...
    createGameDiplomacyPeaceDeclared(
    ...
    createGameDiplomacyWarDeclared(
    ...
    createGamePlayerBadgePurchased(
    ...
    createInfrastructureBulkUpgraded(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        upgradeReport: BulkUpgradeReport,
    ...
    createPlayerCarrierSpecialistHired(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        carrier: Carrier,
    ...
    createPlayerCombatCarrierEvent(
        gameId: DBObjectId,
        gameTick: number,
        combatResult: CombatResult<DBObjectId>,
    ): Promise<void> {
    ...
    createPlayerConversationCreated(
        gameId: DBObjectId,
        gameTick: number,
        convo: Conversation<DBObjectId>,
    ): Promise<void> {
    ...
    createPlayerConversationInvited(
        gameId: DBObjectId,
        gameTick: number,
        convo: Conversation<DBObjectId>,
        playerId: DBObjectId,
    ...
    createPlayerDefeatedEvent(
        args: InternalGamePlayerDefeatedEvent,
    ): Promise<void> {
        this._events.push({ kind: "playerDefeated", ...args });
        return Promise.resolve();
    }

    createPlayerDiplomacyStatusChanged(
        gameId: DBObjectId,
        gameTick: number,
        status: DiplomaticStatus<DBObjectId>,
    ): Promise<void> {
    ...
    createPlayerGalacticCycleCompleteEvent(
        data: InternalPlayerGalacticCycleCompleteEvent,
    ): Promise<void> {
    ...
    createPlayerJoinedEvent(
        args: InternalGamePlayerJoinedEvent,
    ): Promise<void> {
    ...
    createPlayerStarSpecialistHired(
        gameId: DBObjectId,
        gameTick: number,
        player: Player,
        star: Star,
        ...
        for (const event of events) {
            switch (event.kind) {
                case "creditsReceived":
                    await eventService.createCreditsReceivedEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                    ...
                    break;
                case "creditsSent":
                    await eventService.createCreditsSentEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                ...
                case "creditsSpecialistsReceived":
                    await eventService.createCreditsSpecialistsReceivedEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                        event.creditsSpecialists,
                    );
                    break;
                case "creditsSpecialistsSent":
                    await eventService.createCreditsSpecialistsSentEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                ...
                case "debtAdded":
                    await eventService.createDebtAddedEvent(
                        event.gameId,
                        event.gameTick,
                        event.debtorPlayerId,
                        event.creditorPlayerId,
                        event.amount,
                        event.ledgerType,
                    );
                    break;
                ...
                case "giftReceived":
                    await eventService.createGiftReceivedEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                    ...
                    break;
                case "giftSent":
                    await eventService.createGiftSentEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                ...
                case "playerCarrierSpecialistHired":
                    await eventService.createPlayerCarrierSpecialistHired(
                        event.gameId,
                        event.gameTick,
                        event.player,
                        event.carrier,
                ...
                case "playerConversationCreated":
                    await eventService.createPlayerConversationCreated(
                        event.gameId,
                        event.gameTick,
                        event.convo,
                    );
                ...
                case "playerConversationInvited":
                    await eventService.createPlayerConversationInvited(
                        event.gameId,
                        event.gameTick,
                        event.convo,
                        event.playerId,
                ...
                case "playerConversationLeft":
                    await eventService.createPlayerConversationLeft(
                        event.gameId,
                        event.gameTick,
                        event.convo,
                        event.playerId,
                ...
                case "playerDiplomacyStatusChanged":
                    await eventService.createPlayerDiplomacyStatusChanged(
                        event.gameId,
                        event.gameTick,
                        event.status,
                    );
                ...
                case "playerStarSpecialistHired":
                    await eventService.createPlayerStarSpecialistHired(
                        event.gameId,
                        event.gameTick,
                        event.player,
                        event.star,
                    ...
                    break;
                case "renownReceived":
                    await eventService.createRenownReceivedEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                    ...
                    break;
                case "renownSent":
                    await eventService.createRenownSentEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                ...
                case "researchComplete":
                    await eventService.createResearchCompleteEvent(
                        event.gameId,
                        event.gameTick,
                        event.playerId,
                        event.technologyKey,
                        event.technologyLevel,
                        event.technologyKeyNext,
                        event.technologyLevelNext,
                    );
                    break;
                case "starAbandoned":
                ...
                case "technologyReceived":
                    await eventService.createTechnologyReceivedEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
                    ...
                    break;
                case "technologySent":
                    await eventService.createTechnologySentEvent(
                        event.gameId,
                        event.gameTick,
                        event.fromPlayer,
                        event.toPlayer,
