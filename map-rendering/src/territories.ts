...
export class Territories {
    ...
    async draw() {
        ...
        switch (this.userSettings.map.territoryStyle) {
            case "marching-square": {
                const { drawTerritoriesMarchingSquare } =
                    await import("./territories/marchingSquares");
                drawTerritoriesMarchingSquare(
            ...
            case "voronoi": {
                const { drawTerritoriesVoronoi } =
                    await import("./territories/voronoi");
                drawTerritoriesVoronoi(
                    this.game,
                    this.userSettings,
                    this.context,
                    this.container,
    ...
    refreshZoom(zoomPercent: number) {
        ...
        if (this.container) {
            this.container.visible =
                zoomPercent <= this.userSettings.map.zoomLevels.territories;
        }
    }
}
