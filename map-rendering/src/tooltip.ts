...
export default class {
    ...
    _drawTooltip(tooltipData: TooltipData) {
        ...
        graphics.roundRect(
            0,
            0,
            internalContainer.width + PADDING_X * 2,
            internalContainer.height + PADDING_Y * 2,
            1,
        );
        ...
        if (tooltipData.offset.relative) {
            ...
            this.container.y =
                tooltipData.location.y -
                this.container.height / 2 +
                tooltipData.offset.y;
        } else {
            this.container.x = tooltipData.location.x + tooltipData.offset.x;
    ...
    drawTooltipCarrier(carrier: Carrier) {
        ...
        const redraw = () => {
            ...
            const tooltipData = this.tooltipService.getCarrier(
                this.game,
                carrier,
            );
            if (tooltipData) {
