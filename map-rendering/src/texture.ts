...
class TextureService {
    ...
    initialize(urls: TextureUrls) {
        ...
        // STARLESS NEBULAS
        this.STARLESS_NEBULA_TEXTURES.push(Texture.from(urls.STARLESS_NEBULA_1))
        this.STARLESS_NEBULA_TEXTURES.push(Texture.from(urls.STARLESS_NEBULA_2))
        ...
        this.STAR_ASTEROID_FIELD_TEXTURES.push(Texture.from(urls.STAR_ASTEROID_FIELD_1))
        this.STAR_ASTEROID_FIELD_TEXTURES.push(Texture.from(urls.STAR_ASTEROID_FIELD_2))
        this.STAR_ASTEROID_FIELD_TEXTURES.push(Texture.from(urls.STAR_ASTEROID_FIELD_3))
    ...
    _loadPlayerSymbols(urls: TextureUrls) {
        this.PLAYER_SYMBOLS['circle'] = urls.CIRCLES.map(u => Texture.from(u));
        this.PLAYER_SYMBOLS['hexagon'] = urls.HEXAGONS.map(u => Texture.from(u));
        this.PLAYER_SYMBOLS['diamond'] = urls.DIAMONDS.map(u => Texture.from(u));
        this.PLAYER_SYMBOLS['square'] = urls.SQUARES.map(u => Texture.from(u));
    }
    ...
    _loadStarSymbols(urls: TextureUrls) {
        ...
        this.STAR_SYMBOLS['black_hole_binary'] = Texture.from(urls.BLACK_HOLE_BINARY)
        this.STAR_SYMBOLS['binary_scannable'] = Texture.from(urls.BINARY_SCANNABLE)
        this.STAR_SYMBOLS['binary_unscannable'] = Texture.from(urls.BINARY_UNSCANNABLE)
    }
