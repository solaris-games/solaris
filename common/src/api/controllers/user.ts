...
export const createUserRoutes = <ID>() => ({
    listLeaderboard: new GetRoute<
        {},
        { limit: number; sortingKey: string; skip: number },
        UserLeaderboard
    >("/api/user/leaderboard"),
    createUser: new SimplePostRoute<CreateUserReq, { id: string }>(
        "/api/user/",
    ),
    getSettings: new SimpleGetRoute<UserGameSettings>("/api/user/settings"),
    saveSettings: new SimplePutRoute<UserGameSettings, {}>(
        "/api/user/settings",
    ),
    getSubscriptions: new SimpleGetRoute<UserSubscriptions>(
        "/api/user/subscriptions",
    ),
    saveSubscriptions: new SimplePutRoute<UserSubscriptions, {}>(
        "/api/user/subscriptions",
    ),
    ...
    purchaseAvatar: new PostRoute<{ avatarId: number }, {}, {}, {}>(
        "/api/user/avatars/:avatarId/purchase",
    ),
    getAchievements: new GetRoute<{ id: string }, {}, AchievementsUser<ID>>(
        "/api/user/achievements/:id",
    ),
    updateIsAnonymous: new SimplePutRoute<{ enabled: boolean }, {}>(
        "/api/user/changeIsAnonymous",
    ),
    updateEmailPreference: new SimplePutRoute<{ enabled: boolean }, {}>(
        "/api/user/changeEmailPreference",
    ),
    updateEmailOtherPreference: new SimplePutRoute<{ enabled: boolean }, {}>(
        "/api/user/changeEmailOtherPreference",
    ),
    updateUsername: new SimplePutRoute<{ username: string }, {}>(
        "/api/user/changeUsername",
    ),
    updateEmailAddress: new SimplePutRoute<{ email: string }, {}>(
        "/api/user/changeEmailAddress",
    ),
    updatePassword: new SimplePutRoute<
        { currentPassword: string; newPassword: string },
        {}
    >("/api/user/changePassword"),
    requestPasswordReset: new SimplePostRoute<{ email: string }, {}>(
        "/api/user/requestResetPassword",
    ),
    resetPassword: new SimplePostRoute<
        { token: string; newPassword: string },
        {}
    >("/api/user/resetPassword"),
    requestUsername: new SimplePostRoute<{ email: string }, {}>(
