...
export const createCarrierRoutes = <ID>() => ({
    saveWaypoints: new PutRoute<
        { gameId: ID; carrierId: ID },
        {},
        CarrierSaveWaypointsRequest<ID>,
        SaveWaypointsResp<ID>
    ...
    transferShips: new PutRoute<
        { gameId: ID; carrierId: ID },
        {},
        TransferShipsReq<ID>,
        {}
    >("/api/game/:gameId/carrier/:carrierId/transfer"),
    gift: new PutRoute<{ gameId: ID; carrierId: ID }, {}, {}, {}>(
        "/api/game/:gameId/carrier/:carrierId/gift",
    ),
    rename: new PatchRoute<
        { gameId: ID; carrierId: ID },
        {},
        { name: string },
        {}
    >("/api/game/:gameId/carrier/:carrierId/rename"),
    scuttle: new DeleteRoute<{ gameId: ID; carrierId: ID }, {}, {}>(
