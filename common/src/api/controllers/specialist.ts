...
export const createSpecialistRoutes = <ID>() => ({
    ...
    listCarrier: new SimpleGetRoute<Specialist[]>(
        "/api/game/specialists/carrier",
    ),
    listStar: new SimpleGetRoute<Specialist[]>("/api/game/specialists/star"),
    listCarrierForGame: new GetRoute<{ gameId: ID }, {}, Specialist[]>(
        "/api/game/:gameId/specialists/carrier",
    ),
    listStarForGame: new GetRoute<{ gameId: ID }, {}, Specialist[]>(
        "/api/game/:gameId/specialists/star",
    ),
    hireCarrier: new PutRoute<
        { gameId: ID; carrierId: ID; specialistId: number },
        {},
        {},
        CarrierSpecialistHireResult<ID>
    >("/api/game/:gameId/carrier/:carrierId/hire/:specialistId"),
    hireStar: new PutRoute<
        { gameId: ID; starId: ID; specialistId: number },
        {},
        {},
        StarSpecialistHireResult
