...
export type GameInfoState<ID> = Omit<
    GameState<ID>,
...
export type ListGameSettingsGeneral<ID> = Pick<
    GameSettingsGeneral<ID>,
    "playerLimit" | "type" | "featured" | "name" | "playerType"
>;
...
export const createGameRoutes = <ID>() => ({
    getDefaultSettings: new SimpleGetRoute<GameSettingsSpec>(
        "/api/game/defaultSettings",
    ),
    getCurrentFlux: new GetRoute<{}, {}, Flux | null>("/api/game/flux"),
    create: new PostRoute<{}, {}, GameSettingsSpec, { gameId: ID }>(
        "/api/game/",
    ),
    createTutorial: new PostRoute<
        { tutorialKey?: string },
        {},
        {},
        { gameId: ID }
    >("/api/game/tutorial/:tutorialKey"),
    listTutorials: new SimpleGetRoute<Tutorial[]>("/api/game/tutorial/list"),
    detailInfo: new GetRoute<{ gameId: ID }, {}, GameInfoDetail<ID>>(
        "/api/game/:gameId/info",
    ),
    detailState: new GetRoute<{ gameId: ID }, {}, GameStateDetail<ID>>(
        "/api/game/:gameId/state",
    ),
    detailGalaxy: new GetRoute<
        { gameId: ID },
        { tick?: number },
        GameGalaxyDetail<ID>
    >("/api/game/:gameId/galaxy"),
    listSummary: new GetRoute<{}, {}, GameListSummary<ID>>(
        "/api/game/list/summary",
    ),
    listOfficial: new GetRoute<{}, {}, ListGame<ID>[]>(
        "/api/game/list/official",
    ),
    listCustom: new GetRoute<{}, {}, ListGame<ID>[]>("/api/game/list/custom"),
    listInProgress: new GetRoute<{}, {}, ListGame<ID>[]>(
        "/api/game/list/inprogress",
    ),
    listRecentlyCompleted: new GetRoute<{}, {}, ListGame<ID>[]>(
        "/api/game/list/completed",
    ),
    listMyCompleted: new GetRoute<{}, {}, UserActiveListGame<ID>[]>(
        "/api/game/list/completed/user",
    ),
    listActive: new GetRoute<{}, {}, UserActiveListGame<ID>[]>(
        "/api/game/list/active",
    ),
    listMyOpen: new GetRoute<{}, {}, ListGame<ID>[]>("/api/game/list/open"),
    listSpectating: new GetRoute<{}, {}, UserListGame<ID>[]>(
        "/api/game/list/spectating",
    ),
    getIntel: new GetRoute<{ gameId: ID }, {}, Intel<ID>[]>(
        "/api/game/:gameId/intel",
    ),
    join: new PutRoute<{ gameId: ID }, {}, GameJoinGameRequest<ID>, {}>(
        "/api/game/:gameId/join",
    ),
    quit: new PutRoute<{ gameId: ID }, {}, {}, {}>("/api/game/:gameId/quit"),
    concedeDefeat: new PutRoute<{ gameId: ID }, {}, { openSlot: boolean }, {}>(
        "/api/game/:gameId/concedeDefeat",
    ),
    ready: new PutRoute<{ gameId: ID }, {}, {}, {}>("/api/game/:gameId/ready"),
    readyToCycle: new PutRoute<{ gameId: ID }, {}, {}, {}>(
        "/api/game/:gameId/readytocycle",
    ),
    notReady: new PutRoute<{ gameId: ID }, {}, {}, {}>(
        "/api/game/:gameId/notready",
    ),
    readyToQuit: new PutRoute<{ gameId: ID }, {}, {}, {}>(
        "/api/game/:gameId/readyToQuit",
    ),
    notReadyToQuit: new PutRoute<{ gameId: ID }, {}, {}, {}>(
        "/api/game/:gameId/notReadyToQuit",
    ),
    getNotes: new GetRoute<{ gameId: ID }, {}, { notes: string | undefined }>(
        "/api/game/:gameId/notes",
    ),
    writeNotes: new PutRoute<{ gameId: ID }, {}, { notes: string }, {}>(
        "/api/game/:gameId/notes",
    ),
    pause: new PutRoute<{ gameId: ID }, {}, { pause: boolean }, {}>(
        "/api/game/:gameId/pause",
    ),
    forceStart: new PostRoute<
        { gameId: ID },
        { withOpenSlots: boolean },
        {},
        {}
    >("/api/game/:gameId/forcestart"),
    fastForward: new PostRoute<{ gameId: ID }, {}, {}, {}>(
        "/api/game/:gameId/fastforward",
    ),
    kick: new PostRoute<{ gameId: ID }, {}, { playerId: ID }, {}>(
        "/api/game/:gameId/kick",
    ),
    getPlayerUser: new GetRoute<
        { gameId: ID; playerId: ID },
        {},
        InGameUser<ID> | null
    >("/api/game/:gameId/player/:playerId"),
    touch: new PatchRoute<{ gameId: ID }, {}, {}, {}>(
    ...
    resetQuitters: new DeleteRoute<{ gameId: string }, {}, null>(
        "/api/admin/game/:gameId/quitters",
    ),
});
