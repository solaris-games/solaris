...
export class GetRoute<
    ...
    QueryParams extends Object,
    Resp,
> extends Route<PathParams, QueryParams, null, Resp> {
...
export class PatchRoute<
    PathParams extends Object,
    QueryParams extends Object,
    Req,
    Resp,
> extends Route<PathParams, QueryParams, Req, Resp> {
    constructor(path: string) {
        super(path, "PATCH");
    }
}

export class SimplePatchRoute<Req, Resp> extends PatchRoute<
    {},
    {},
    Req,
    Resp
